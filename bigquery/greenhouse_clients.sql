...
CREATE TABLE IF NOT EXISTS `efeonce-group.greenhouse.clients` (
  ...
  primary_contact_email STRING OPTIONS(description = "Primary login email for MVP credentials auth"),
  ...
  auth_mode STRING OPTIONS(description = "env_demo, credentials, or sso"),
...
USING (
  SELECT
    ...
    'Bootstrap tenant for the Greenhouse portal MVP. Move auth to password_hash or SSO before production go-live.' AS notes,
