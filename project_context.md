...
| Cómo operar la landing pública de Emma para ANAM y su seam con Customer Agent | `.codex/skills/hubspot-as-a-service/SKILL.md` + `.codex/skills/hubspot-as-a-service/references/anam-case.md` + `docs/architecture/kortex/hubspot-cms/anam-chat-landing.md` + `docs/architecture/kortex/hubspot-cms/landing-page-runbook.md`; CMS, Customer Agent y CRM conservan ownership separado y el estado publicado exige readback de la URL pública |
