...
- **Creative Operations / agents (research activo, 2026-07-12):** `RESEARCH-009` formaliza que exploración creativa y producción repetible son modos distintos; el agente propone un plan editable, dirección creativa actúa como builder de templates/rúbricas y producción como runner con inputs semánticos. No cambia el runtime/ADR: informa el bootstrap de EPIC-028 y preserva autorización humana sobre gasto, delivery y publicación. Canon: `docs/research/RESEARCH-009-creative-operations-agentic-workflows.md`.
