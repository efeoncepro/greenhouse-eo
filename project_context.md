...
- **Pillar Web agéntica en revisión privada (2026-07-18):** el post WordPress `249387`, `El fin de la web “solo para humanos”`, permanece `draft` y soporta editorialmente `/desarrollo-sitios-web/`. El corte vigente usa 95 bloques semánticos, 4.448 palabras, tres infografías art-directed light/dark y desktop/mobile, y evidencia actualizada de WebMCP/Chrome, evals, mercado y autoridad delegada. Canon: `docs/public-site/WEB_AGENTICA_PILLAR_CLUSTER_BRIEF_V1.md`, `WEB_AGENTICA_PILLAR_GUTENBERG_SPEC_V4.json`, `WEB_AGENTICA_EDITORIAL_VISUAL_SYSTEM_V1.md` y su manifest. Publicación, enlace recíproco, purge y QA live siguen sujetos a autorización humana explícita.
