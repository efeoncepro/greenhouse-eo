...
- **Public Site bridge skeleton (2026-06-14):** el repo runtime `/Users/jreye/Documents/efeonce-public-site-runtime` ahora contiene `wp-content/plugins/greenhouse-wp-bridge` version `0.1.0` como foundation read-only no desplegada. Rutas actuales: `GET /wp-json/greenhouse-wp-bridge/v1/health`, `GET /wp-json/greenhouse-wp-bridge/v1/inspection/elementor-document/{id}`, `GET /wp-json/greenhouse-wp-bridge/v1/inspection/ohio-widget-catalog`; requieren usuario autenticado con `edit_posts`. Estado honesto: PHP lint verde local; no esta instalado/activado en Kinsta; no tiene HMAC/replay guard, Abilities registration ni endpoints de draft write/publish/cache.
