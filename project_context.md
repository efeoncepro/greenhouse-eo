...
| Cómo separar Organization, Engagement comercial, Project/Campaign y Task para operar On-Going y On-Demand | `docs/business-models/EFEONCE_ENGAGEMENT_PROJECT_OPERATING_MODEL_V1.md` + `EFEONCE_PRODUCT_SERVICE_OPERATING_MODEL_V1.md` |
