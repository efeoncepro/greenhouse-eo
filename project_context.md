...
| Cómo operar la landing, Customer Agent y handoff de Emma para ANAM | `.codex/skills/hubspot-as-a-service/references/anam-case.md` + `docs/architecture/kortex/hubspot-cms/anam-chat-landing.md` + source pack `07-identidad-directrices-handoff-y-canales.md`; CMS, agente, routing y CRM conservan ownership y readback separados |
