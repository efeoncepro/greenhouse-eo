...
- **Skill actualizable Efeonce Public Site WordPress (2026-06-14):** existe una skill viva para consolidar lo aprendido de `efeoncepro.com`, WordPress/Kinsta, Ohio + Elementor, WP-CLI/REST, WP Abilities, React/Interactivity boundary y el bridge Greenhouse→WordPress. Paths sincronizados: `.codex/skills/efeonce-public-site-wordpress/SKILL.md` y `.claude/skills/efeonce-public-site-wordpress/SKILL.md`. Usarla cuando el trabajo toque Public Site, `EPIC-019`, `TASK-1111`, `TASK-1116`, discovery autenticada, fixes de layout Ohio/Elementor o diseño del bridge; actualizar ambas copias tras nuevos incidentes/discoveries/decisiones oficiales de WordPress sin incluir secretos.
