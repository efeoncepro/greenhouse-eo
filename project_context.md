...
- **Public Site `/desarrollo-sitios-web/` — landing premium completa + Growth Form real (TASK-1345, 2026-07-06):** la landing live `https://efeoncepro.com/desarrollo-sitios-web/` (`page_id=250816`) ya tiene polish premium/enterprise desde hero hasta FAQ y cierre. La sección final es `final final-premium final-growth-form` (`id="cotizar"`, CSS `task-1345-final-growth-form-v1`) y embebe el Growth Form real `efeonce-desarrollo-web-cotizacion` (`formKey=00231d6c-e1a0-4857-ae5b-a27262ae8b69`, `surface=fhsf-2d4b97ad-7076-4958-8e0f-daf1c995e430`, v2 `fver-6fc638de-5948-407d-be0b-31954fe29877`, `diagnostic_premium`, Turnstile invisible). Los CTAs de conversión apuntan a `#cotizar`; `/contacto/` queda como navegación/fallback. HubSpot direct delivery sigue `disabled` y gated por TASK-1264/operator cutover. Evidencia live: API/CORS v2 OK, POST sin captcha `403 captcha_failed/missing_token` sin crear submissions, Playwright desktop/mobile 390/reduced sin overflow y header Ohio nativo; capturas `.captures/task-1345-final-growth-form-v2/`.
- **Public Site `/desarrollo-sitios-web/` — header/hero nativo Ohio + Hero Factory v14 integrado al degradado global (TASK-1345, 2026-07-05/06):** la landing live `https://efeoncepro.com/desarrollo-sitios-web/` (`page_id=250816`) usa Elementor `Document::save()` con hero nativo `wdhero` estilo AEO/Home y contenido `wdrest`. Invariante operativo: el header queda gobernado por Ohio (`with-header-3`, `#masthead.header-3.light-typo`) y no por CSS/JS custom; no reintroducir reglas propias contra `#masthead`, `#content`, `.page-container`, `.elementor-250816`, `#site-navigation` ni wrapper resets. El CSS de contenido `.gh-v11` sigue permitido scoped a la landing. El visual estatico `wdans` ya fue retirado; `wdvis` ahora contiene la animacion Hero Factory premium (`whfd06a1`, `.ghf-slot ghf-slot-premium-v2 ghf-slot-right-v14`) basada en `ai-generations/2026-07-05_task-1345-hero-interface/hero-factory-demo-v2.html`. No reintroducir `ghf-sweep`, tween `[data-sweep]`, scan pass ni fondo local/grain de animacion (`ghf-field`, `ghf-floor`, `ghf-glow`, `ghf-grain`): el widget debe vivir directamente sobre el degradado global del hero. CSS activo: `task-1345-hero-right-block-v14` sobre `task-1345-hero-premium-system-v8`, con bloque derecho reestructurado como sistema enterprise (motor humano+agente, rail `Spec/Build/QA`, nodos, estacion de armado y delivery card) y visual equilibrado contra el bloque izquierdo (desktop `541x634`, mobile `310x347`), sin header/wrappers. Backups recientes: `_gh_backup_before_task1345_hero_right_block_v13_20260706T033232Z`, `_gh_backup_before_task1345_hero_right_block_v14_20260706T033636Z`, `_gh_backup_before_task1345_hero_right_block_v14_20260706T033901Z`; evidencia live en `.captures/task-1345-hero-right-block-v14/`.
