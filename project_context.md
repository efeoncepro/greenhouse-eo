...
- **Creative Workflows FAQ disclosure + schema V6 publicada (2026-07-16):** el runtime WordPress `7.0.1`/Ohio del post
  ...
  `Preguntas frecuentes` y un `FAQPage` JSON-LD sincronizado (`FAQPage=1`, `Question=4`). No se creó un custom block
  runtime porque el authoring vigente de posts agentic vive en la spec; un `efeonce/faq` Gutenberg block queda como fase
  futura si humanos necesitan autorar FAQs directamente en el editor. Write live aplicado con snapshot/rollback, cache
  purge y QA anónima desktop/mobile PASS; canonical/robots/OG se preservan y el TOC sólo apunta al H2. Canon:
  `docs/public-site/CREATIVE_WORKFLOWS_FAQ_DISCLOSURE_DECISION_V1.md`; evidencia:
  `docs/operations/public-site-content-factory/post-deep-inspection-251363-2026-07-16T05-52-24+00-00.json`.
...
- **Creative Workflows es soporte científico/editorial, NO implementación operativa (2026-07-15):** [PDR-014](docs/public-site/decisions/PDR-014-creative-workflows-territorio-editorial-pillar-cluster.md) fija una Pillar educativa y 12 satélites bajo la tesis **“un sistema de decisiones creativas humanas vuelto ejecutable”**. El [brief maestro](docs/public-site/CREATIVE_WORKFLOWS_PILLAR_CLUSTER_BRIEF_V1.md) prepara contenido, fuentes, preguntas y distribución para sostener Creative Studio futuro; sus secciones, diagramas, checklists o templates conceptuales **no son product specs, workflows ejecutables ni child tasks**. La implementación sólo puede nacer después desde RESEARCH-009 + arquitectura vigente + EPIC-028 y tasks formales en el repositorio de Creative Studio. Estado editorial vigente: V6 está **publicada** en `https://efeoncepro.com/creative/creative-workflows/` (`post 251363`, autor `1`, categoría `Creative`, 4 `core/details` en FAQ, cinco imágenes, seis captions, tabla nativa y featured/OG `251370`). Los diagramas textuales V3 (`251393` frontera y `251392` autonomía) usan tipografía determinista, reservan la safe area del chrome Ohio, evitan cruces internos de conectores/copy y enlazan a media completa en mobile; V1/V2 permanecen superseded. `kind=table`, `kind=details`, captions, `linkDestination` y `public-website:wpcli --input-file` son capacidades gobernadas del Content Factory/rail SSH. Canon visual V5: `docs/public-site/CREATIVE_WORKFLOWS_PILLAR_VISUAL_ENRICHMENT_V5.md`; FAQ V6: `docs/public-site/CREATIVE_WORKFLOWS_FAQ_DISCLOSURE_DECISION_V1.md`; el corte E-E-A-T V4 permanece como evidencia histórica.
