...
- **EPIC-026 / TASK-1379 — desacople físico rechazado por evidencia (`no-go`, 2026-07-10):** el A/B de una proyección Roadmap gzip eliminó 2.493 Markdown de los tres traces, redujo sus artifacts 88,6–96,2% y mejoró clean p50 19,9%, pero warm RSS p95 subió 9,8% (7,51→8,25 GB), incumpliendo el target obligatorio de -10%. El cutover experimental fue revertido: Markdown y el reader filesystem siguen como SSOT/runtime vigente; no se crearon `apps/*`, `packages/*`, proyectos Vercel ni deployables. ADR `Rejected`, EPIC-026 `complete/stopped`; no reabrir extracción física sin una hipótesis distinta que demuestre memoria además de tamaño/tiempo. El enforcement extraction-ready de TASK-1377 permanece obligatorio para trabajo nuevo. Evidencia: `docs/audits/platform/2026-07-10-roadmap-materialized-index-ab.md` + `docs/architecture/GREENHOUSE_MODULAR_BUILD_RUNTIME_DECISION_V1.md`.
