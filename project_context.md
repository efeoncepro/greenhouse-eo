...
| Cómo opera el scheduler nativo y su booking/medición | `docs/architecture/GREENHOUSE_GROWTH_MEETINGS_SCHEDULER_ARCHITECTURE_V1.md` + skill `greenhouse-growth-meetings` |
