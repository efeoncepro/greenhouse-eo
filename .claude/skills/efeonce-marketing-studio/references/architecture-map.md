...
| PG role (TASK-1896, created by SQL 2026-09-26) | `marketing_studio_restore` (LOGIN CREATEDB NOCREATEROLE INHERIT, conn limit 3, member of `marketing_studio_runtime`). The migrator has NO `CREATEDB` (verified 2026-09-26) |
| Restore rehearsal (TASK-1896, live 2026-09-26) | SA `marketing-studio-restore@`, bucket `efeonce-marketing-studio-restore-dumps` (30-day delete), image `us-east4-docker.pkg.dev/efeonce-group/marketing-studio/restore-rehearsal:<sha>`, Cloud Run Job `marketing-studio-restore-rehearsal` (us-east4), Scheduler same name (Tue 05:30 Santiago, ENABLED since 2026-09-26) |
| Monitoring (TASK-1896, live 2026-09-26) | Uptime check `studio-api-v1-health-A2vbXH5AjzI` (4 regions, 5 min), policy `17467591732187545239`, email channel `11422563510758505577` |
| Sentry (TASK-1896, live 2026-09-26) | Org `efeonce-group-spa`, project `efeonce-marketing-studio` (id `4512153019809792`), envs `production`/`preview`; custom alert rules not created (Workflows) |
| Originals (TASK-1893, live 2026-09-26; worker prod `00001-sgb`, staging `00002-svt`) | Buckets `efeonce-marketing-studio-originals[-staging]`; SAs `marketing-studio-ingest[-stg]@`, `marketing-studio-worker[-stg]@`, `marketing-studio-invoker@`; custom role `marketingStudioOriginalsMetadataWriter`; topics `marketing-studio-originals-finalized[-staging]` (+ `-dlq`, `-worker` push sub, `-dlq-sub`); Cloud Run `marketing-studio-media-worker[-staging]`; Scheduler `marketing-studio-reconcile-derivatives[-staging]`, `marketing-studio-metricool-readback`; PG roles `marketing_studio_worker` / `marketing_studio_staging_worker` (limit 6) |
...
(a full `.npmrc`). Created 2026-09-26 (TASK-1896): `marketing-studio-sentry-dsn`, `marketing-studio-pg-restore-password`,
