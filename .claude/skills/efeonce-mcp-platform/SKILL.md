...
- The live runtime federates only the internal read-only Hiring provider from `TASK-1726`:
...
| Hiring/ATS, Talent Pool, candidate review, assessment assignment or selection journey | `greenhouse-talent-people-operator` + identity/integrations owners | `TASK-1726` Talent Pool readers are live internal-only and never expose CV/contact or write. `TASK-1718`–`TASK-1722` and `TASK-1631` retain the other read/write/external gates. |
