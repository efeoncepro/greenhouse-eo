...
| **Berel** | ✅ Cliente real. |
| **Borradores de caso en Notion** *(workspace "Tareas")* | ⚠️ Ghamadent, Eusari/Menoplay, SSilva *(sólo anonimizado)*, Touch Latam, Grupo Norte, Grupo Security — mayormente performance/CRM/ecommerce, no creativo de marca. **Borradores internos no verificados; confirmar autorización y fuente antes de citar.** |
