...
Antes de proponer una receta, lee la guía
`../axis-design-system/docs/creative-applications/advertising-social/DESIGN.md` y abre el
[Creative Typography Workbench](https://axis.efeonce.org/references/creative-typography/). En el asesor público,
selecciona el soporte, el largo real del titular y la intención para obtener una hipótesis de contraste: peso de
Bricolage para la idea, rol/peso de Poppins para la estructura, decisión explícita de incluir u omitir Guttery,
ritmo, safe area y caso comparable. Después resuelve los valores exactos desde `axisAdvertising` y valida la
composición final en su tamaño y fondo reales. Si la proyección visual contradice el contrato versionado, el
contrato gana y el drift se reporta; no se corrige a ojo.

El asesor enseña y orienta, pero no aprueba una pieza. Su salida no sustituye criterio de diseño, revisión de
marca, accesibilidad sobre píxeles reales, aprobación del cliente ni autorización para publicar. Tampoco convierte
las fuentes publicitarias en familias globales de producto ni autoriza empaquetar archivos con licencia.
