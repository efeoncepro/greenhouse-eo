...
| **Gemini Omni** (Google, Vertex) | multimodal, **edición conversacional multi-turn** con consistencia de personaje/físico | ecosistema nuevo | edición iterativa preservando contexto entre pasos; en `efeonce-group` |
