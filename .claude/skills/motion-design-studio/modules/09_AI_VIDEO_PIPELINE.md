...
| **Gemini Omni 1.1 Flash** | Texto, imagen, cuadros, referencias, edit y extend desde MP4 | `pnpm ai:omni` Cloud directo (nunca fal). Seis modos probados técnicamente sólo a 360p/16:9/3 s; `extend` entregó 6 s acumulados. Cadena conversacional stateful, continuidad fina, 720p/1080p/4K y 9:16 sin probar; manual `docs/manual-de-uso/ai-tooling/gemini-omni-1-1-cli.md` |
