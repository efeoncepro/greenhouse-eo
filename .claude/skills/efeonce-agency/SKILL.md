...
**El Why como CONTENT ENGINEERING.** Efeonce adopta Content Engineering como doctrina editorial emergente: el contenido deja de ser una entrega estática y se diseña para volver a la persona más capaz de comprender, verificar y decidir, mientras agentes/motores consumen la misma verdad estructurada. Es territorio de thought leadership y método en construcción, no sub-marca, producto ni oferta empaquetada todavía. Decisión: `docs/public-site/decisions/PDR-017-content-engineering-territorio-editorial.md`; doctrina reusable: `content-marketing-studio/references/content-engineering.md`.

**Primer wrapper vivo de la Experiencia Efeonce (SKY, 2026-07-13).** `https://experiencia.efeoncepro.com` es el primer **Efeonce Wrapper** cliente-facing: una experiencia anual creada para SKY por su primer año con Efeonce, operada desde el repo satélite `efeoncepro/sky-efeonce` y documentada en `sky-efeonce/docs/experiencia/`. Tratarlo como prueba de dirección para `"Tu año con Efeonce"`, no como automatización ya existente en Greenhouse ni como caso público autorizado sin permiso escrito. **Actualización 2026-09-23:** el wrapper muestra el **caso creativo de SKY** (12 meses) con métricas de **entrega/operación** — +2.000 piezas aprobadas, 39 campañas, 88% on-time, 0,12 ajustes por pieza, 5 mercados, −25% tiempo de producción; no son métricas de negocio del cliente ni hay baseline del día 0, y citarlo fuera del wrapper exige verificar la autorización escrita. Caso de referencia detallado: caso documentado **Travel Sale · Sky Airline** (Notion `MET-1530`, aprobado; marzo 2026): 4 mercados + Brasil, 178 piezas (66 de Efeonce), −21–25% de tiempo total de campaña (producción −24–26%, adaptación −30–40%) y cambios de precio en 27 piezas —incluidos 9 videos— en 10 minutos; tiene PDF/one-pager, blog y video de YouTube asociados.
...
- **Efeonce Group** = marca paraguas y relación comercial de un portfolio de líneas de negocio/prácticas y product brands. Un solo interlocutor (Director de Cuenta), sin pérdida de contexto. Opera en Chile, Estados Unidos, Colombia, México y Perú (+10 años LATAM; cobertura confirmada por el operador el 2026-08-31, sin inferir oficinas o entidades legales por país), pero la ambición es global-ready: LATAM es prueba de ejecución multi-país, no límite de categoría. En producto se traduce a **multi-tenant + multi-línea + multi-país + multi-moneda**.
...
- **Portfolio comercial:** Creative Services (Globe/Creative Studio cuando aplica) · Digital Services & Engineering (Wave cuando aplica) · RevOps & CRM (Kortex + HubSpot-first, Salesforce-first o híbrido gobernado según fit) · Media & Distribution (Reach cuando aplica) · Growth Strategy & Measurement (Greenhouse, Verk, Wave y Kortex según scope). Estas líneas no son proveedores separados; el cliente contrata a Efeonce.
- **Media & Distribution:** comercialmente se presenta mediante tres soluciones —Distribution Strategy & Media Architecture; Performance & Commerce Distribution; e Influence, Earned & Partnership Distribution— que activan siete capacidades de delivery. Performance & Commerce se gobierna por señales first-party, creative performance, commerce, medición e IA algorítmica; no se reduce a configurar Google/Meta. Consultar `docs/services/media-distribution/README.md` y su benchmark fechado. Reach es la product brand habilitadora, no la agencia ni la línea completa; IMO y Managed Media Operations son capas operativas, no ofertas adicionales.
- **ICO — Intelligent Creative Operations**: capa de inteligencia operativa transversal a las líneas donde aplica (no una unidad ni una product brand exclusiva de Globe). Gobernanza por IA + métricas en vivo por pieza + visibilidad total al cliente. 4 dimensiones: **Production · Concept · Outcome · Anticipation**. No se vende suelto: *es la forma en que Efeonce opera.*
...
- **Marca hacia afuera = Efeonce (masterbrand/paraguas).** Las líneas de negocio se describen por su función y oferta. Las product brands (Globe, Wave, Reach, Kortex, Verk) se nombran cuando aportan claridad o diferenciación, pero nunca se presentan como agencias/proveedores contractuales separados. Los claims **"Empower your…"** expresan el modo en que Efeonce opera una capability; no convierten la capability en sub-marca contractual. Canon: `docs/architecture/EFEONCE_PORTFOLIO_BRAND_BUSINESS_LINE_ARCHITECTURE_V1.md`.
