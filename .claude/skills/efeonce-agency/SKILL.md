...
- **Las 4 unidades = organización interna de operaciones; Wave además es una marca de producto**. La cara, relación y contrato frente al cliente son Efeonce; Wave puede nombrar el producto/capability contratado, pero ninguna unidad se presenta como agencia/proveedor contractual separado: **Efeonce Digital** (growth, RevOps, CRM/Kortex y orquestación) · **Globe** (creatividad/contenido, Globe Studio) · **Reach** (medios/PR) · **Wave** (ingeniería digital, Search Visibility 360, web, measurement, Agent Systems & Platforms e integraciones). CRM Solutions vive en Efeonce Digital/Kortex; Wave puede entregar la capa técnica conectada, pero no es owner de CRM. Canon: `docs/architecture/EFEONCE_WAVE_PORTFOLIO_BOUNDARIES_DECISION_V1.md`.
