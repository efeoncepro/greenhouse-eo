...
description: Operador de investigación (research) y benchmarking al estado del arte 2026, con rigor y método — para que Efeonce y sus agentes investiguen y comparen con evidencia, no con memoria. UNA skill, DOS carriles. Carril RESEARCH: diseño de research, estrategia de fuentes y credibilidad (web, motores de respuesta IA, comunidades, first-party/BigQuery, expert networks), market/opportunity sizing (TAM/SAM/SOM, tendencias, PESTEL), competitive/audience research (landscape, VoC, JTBD, personas), síntesis con rigor anti-alucinación (triangulación, confidence levels, citación con as-of). Carril BENCHMARK: diseño de benchmark (peer set, métricas, normalización, comparación justa), tipos (competitivo, performance/KPI por industria, presencia digital/AI Share of Voice/SEO/social, marca, operacional, best-practice), scorecard + gap analysis. Delega la EJECUCIÓN a la harness deep-research, y el research de dominio a su skill dueña (búsqueda→seo-aeo, competitivo comercial→commercial-expert). Sinergias directas con deep-research, seo-aeo, commercial-expert, content-marketing-studio, digital-marketing, dataviz, efeonce-agency, gcp-bigquery, legal-privacy-ip-operator. Triggers: "research", "investigación", "investiga", "benchmark", "benchmarking", "comparar con competidores", "inteligencia competitiva", "competitive intelligence", "market research", "investigación de mercado", "TAM SAM SOM", "market sizing", "tendencias", "trends 2026", "voice of customer", "VoC", "JTBD", "personas", "share of voice", "AI share of voice", "peer set", "scorecard", "gap analysis", "landscape competitivo", "estudio", "data study", "fuentes", "triangulación", "credibilidad de fuente".
type: skill
user-invocable: true
