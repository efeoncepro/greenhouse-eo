...
**(c) 🔴 La atribución de AEO a revenue NO existe.** Nadie puede probar hoy que ser citado por ChatGPT generó
X pesos. **Quien lo promete, miente.** 🎯 **Y ahí está la jugada:** decir *"esto lo medimos, esto lo
correlacionamos, y esto todavía no se puede atribuir — y no te lo vamos a inventar"* **es el movimiento más
desarmante posible en un mercado de mentirosos.**
...
| Cuándo | Módulo | Estado |
|---|---|---|
| **Precio, margen, piso, descuentos, FX, cuándo levantarse de la mesa** | **`modules/04_PRICING.md`** | ✅ **escrito** |
| El estado real de la práctica: Berel, SKY, el Grader, los gaps | **`efeonce/ESTADO_ACTUAL.md`** | ✅ **escrito** |
| Qué se puede afirmar y con qué evidencia | **`SOURCES.md`** | ✅ **escrito** |
| El mercado real 2026 (AI Overviews vs CTR, zero-click, tráfico LLM) | `modules/01_MERCADO_2026.md` | 🔜 pendiente — 🔴 **todo debe verificarse, nada de memoria** |
| El comprador y su cicatriz: ICP, comité, las objeciones que matan el deal | `modules/02_COMPRADOR.md` | 🔜 pendiente |
| La oferta: el reframe de "SEO" a visibilidad. Empaquetado | `modules/03_OFERTA.md` | 🔜 pendiente |
| La cuña: el Grader como motor de venta (y su migración de "medimos" a "movemos") | `modules/05_CUNA_GRADER.md` | 🔜 pendiente |
| **Descalificación**: cuándo NO vender SEO | `modules/06_DESCALIFICACION.md` | 🔜 pendiente |
| Displacement: el freelancer · el in-house · la herramienta · **no hacer nada** | `modules/07_DISPLACEMENT.md` | 🔜 pendiente |
| Prueba sin mentir: cómo demostrar que funciona sin inventar atribución | `modules/08_PRUEBA.md` | 🔜 pendiente |
| **Canales, prospección y outbound** para vender esto | `modules/09_CANALES_OUTBOUND.md` | 🔜 pendiente |
| La conversación: discovery, deck, propuesta, negociación, QBR | `modules/10_CONVERSACION.md` | 🔜 pendiente |
| El retainer que sobrevive: por qué la mayoría muere al mes 9 | `modules/11_RETENCION.md` | 🔜 pendiente |

🔴 **Los módulos marcados 🔜 NO existen todavía. No los cites ni los inventes.**
*(Esta tabla es honesta a propósito: un router que apunta a archivos inexistentes es el bug que ya encontramos
en `commercial-expert`.)*
