...
| 🔴 **BENCHMARK de la competencia** — suites, pure-plays, enterprise y cobertura es-LATAM, con lo que **NO** podemos decir (F-01…F-12), lo que **SÍ** (S-01…S-08) y **lo que descubrió sobre nosotros**. **Cárgalo ANTES de escribir cualquier diferenciador técnico, de citar cobertura LATAM o precio de competencia, y antes de prometer robustez de medición.** `as-of 2026-08-15`, **caduca 2026-11-15** | **`references/BENCHMARK_SUITES_AEO_2026-08.md`** |
