...
| Influencer Marketing, Creators & UGC | `https://efeoncepro.com/servicios/influencer-marketing/` | — | planned | `landings/influencer-marketing.md` | TASK-1598; working slug pending SERP/keyword validation; SEO/AEO brief + entity/schema/internal-link gates; reuse Growth Forms/CTA/Meetings; no public creator directory; proof and rights method required before publish |
