...
> (auditar con Semrush MCP, verificar frescura con WebSearch/WebFetch, generar
...
> lidera), **reverifica con WebSearch**. Ver `SOURCES.md` para niveles de
...
4. **Verifica lo volátil.** Si vas a citar un dato 2026 (cifra, umbral, feature
   de un motor), pásalo por WebSearch antes de escribirlo como hecho.
...
- **Semrush MCP** — keyword research, organic research, backlink research, site
  audit, trends, overview. Úsalo para *datos reales* en vez de estimar. Flujo:
  ...
  mensaje).
- **WebSearch / WebFetch** — (a) frescura de algoritmo/feature; (b) **medición
