...
- **Los ojos de una persona real se declaran como un bloque propio, o salen mal.** Pedir «ambos ojos simétricos» no basta: el modelo los cierra con la sonrisa y les pone el color por defecto. Hay que declarar, mirando la foto real: (1) la **forma y apertura** — «almendrados y ABIERTOS, con el blanco visible a los lados del iris; no entrecerrados, no achinados por la sonrisa; haga lo que haga la boca, los ojos quedan abiertos»; (2) el **color del iris** — el caso fuente salió marrón oscuro dos veces hasta declarar «iris CLAROS, anillo azul grisáceo alrededor de un centro ámbar»; (3) la **construcción exacta de las gafas** — semi al aire, barra de metal sólo arriba, nada de metal bajo el cristal, cristales sin reflejo y sin aumento, la barra por encima de las pupilas sin cortarlas. Y separar gesto de mirada: «la sonrisa vive en la boca y en las cejas». Caso medido: `ai-generations/2026-09-17_claude-o-codex/LEEME.md`.
