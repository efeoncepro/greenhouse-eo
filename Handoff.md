...
**EPIC-044 / TASK-1836, 2026-09-05:** backend local, tres migraciones aplicadas; passkey UV, límites y GC corregidos. Suite: 382 passed; persistencia/identidad/GC/UV/caducidad comprobadas antes en PG. App Entra/secreto/KMS preparados, sin enrolamiento/grant MCP real. Gateway TASK-1831: 114 tests y canary HTTP simulado propio/deny ajeno; reconstruir contenedor. UI TASK-1835: shell real y step-up TOTP/UV/QR locales; cuatro GVC desktop/móvil y seis checks de navegador con mocks pasan. Rollout autorizado; UI completa pendiente. DTO/retorno/Microsoft/CSRF integrados. Sin nuevos deploys; readback 14:25 UTC: auth ready y gateway anuncia Entra. Pendientes: consumers desplegados, providers compatibles, canaries/rollback reales. TASK-659 conserva historia. [Runbook](docs/operations/EFEONCE_INTERNAL_AUTH_ROLLOUT_RUNBOOK_V1.md).
