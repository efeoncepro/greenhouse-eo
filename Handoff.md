...
**Segunda pasada del mismo día — pieza-hito anual del mismo cliente (color del año 2027).** Sólo docs y skills. Se produjo el brief completo en el slot ya ubicado del sistema editorial del cliente: 13 secciones dentro de un desplegable (las 11 del formato hermano + plan de PR y link building + atomización y distribución + límites). El ángulo se decidió contra evidencia: el material del cliente cubre la capa editorial completa y trae el eje ganador explícito, pero **dos piezas propias recientes ya ocupaban el territorio obvio** y **un tercero fuera de la categoría publicó la misma tesis con el mismo mecanismo seis semanas antes**.
