...
**EPIC-044 rollout (Codex, 2026-09-04):** OAuth/personas ON verificados en `auth-server-00007-cxb`, SHA `3f68e8875`, 100% tráfico; workflow staging `33934410457` success sobre servicio compartido. Environment active; 9/9 canaries públicos/negativos. Corregidos IAM Resend runtime y KMS viewer deployer. Identidad interna indicada: acceso nativo pendiente de nueva TASK-1836 (U11); TASK-659 conserva su historia; consumers 1831/1835, canaries 1832. Ejecución 2026-09-05: ADR aceptado, backend interno/OAuth/contextos, enrolamiento y reader implementados; dos migraciones aplicadas y PG verificado. Corregidos límites passkey y GC tras aviso de Claude. Código local; sin nuevo deploy/enrolamiento real. App Entra, consumers 1831/1835/1832 y rollback real pendientes. [Operación/evidencia](docs/operations/EFEONCE_INTERNAL_AUTH_ROLLOUT_RUNBOOK_V1.md). Sin nuevo release main: el árbol anterior puede apagar flags al redeploy. [Evidencia](docs/audits/2026-09-04-epic-044-auth-rollout.md).
