...
**Línea gráfica «La órbita» (25/09):** canónica ([ADR](docs/architecture/EFEONCE_GRAPHIC_LINE_ORBIT_DECISION_V1.md), [manual](docs/operations/brand-graphic-line/EFEONCE_GRAPHIC_LINE_V1.md)); AXIS en vivo en axis.efeonce.org/references/graphic-line, proyecto Vercel conectado a GitHub (push a `main` despliega). Skills y docs barridos. Pendiente: contrato semántico de composición de la órbita en AXIS (hoy tokens + página), prueba sin logo, firma A/B.
