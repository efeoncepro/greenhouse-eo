...
**Marketing Studio (25/09):** en vivo en https://studio.efeonce.org (abierto, solo lectura). [TASK-1890](docs/tasks/in-progress/TASK-1890-marketing-studio-agent-ready-contract.md) en producción de Studio: registro de operaciones → OpenAPI 1.1.0 + manifiesto `studio-tool-manifest.v1` (12 tools `studio.*`), bearer `api_client` (`marketing-studio-mcp-gateway-token`), organización canónica, detalle y preview de pieza. En Greenhouse: capability `marketing_studio.campaign.read` aplicada y manual `marketing-studio` commiteado; **falta release a producción para servir el manual** (develop sin push: el commit remoto `ebee01809` choca con WIP de `scripts/foto`). Siguiente: [TASK-1891](docs/tasks/to-do/TASK-1891-marketing-studio-mcp-federation.md) (federación en mcp.efeonce.org). Programa completo TASK-1890…1899 en [EPIC-049](docs/epics/in-progress/EPIC-049-efeonce-marketing-studio-platform.md). Runbook: [runtime handoff](docs/operations/marketing-studio/MARKETING_STUDIO_RUNTIME_HANDOFF.md).
