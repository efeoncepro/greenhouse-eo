...
| Sitio público (landings/posicionamiento/roadmap/blogposts agentic) | `efeonce-public-site-wordpress` + `seo-aeo`/`commercial-expert` | `docs/public-site/` + `docs/operations/public-site-content-factory/AGENTIC_BLOGPOST_END_TO_END_RUNBOOK_V1.md` (private por defecto; publish con autorización, snapshot, rollback y QA live) |
