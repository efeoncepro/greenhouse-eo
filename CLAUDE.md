...
| **Informes ejecutivos, auditorías y desempeño; HTML como insumo PDF** | `report-studio` + skill de dominio | `docs/operations/EFEONCE_REPORT_BRAND_DELIVERY_STANDARD_V1.md`; evidencia, continuidad, narrativa, A4, gráficos y QA del archivo final |
