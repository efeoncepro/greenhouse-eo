...
const output = 'generated/brand-visibility-grader-social/instagram-1080x1350-v11.png'
...
const background = `<svg width="1080" height="1350" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="84" y="286" fill="#ffffff" font-family="Poppins, Arial, sans-serif" font-size="68" font-weight="700">¿Tu marca aparece</text>
  <text x="84" y="369" fill="#7de0d1" font-family="Poppins, Arial, sans-serif" font-size="68" font-weight="800" font-style="italic">cuando la buscan?</text>
  <text x="84" y="445" fill="#ffffff" font-family="Poppins, Arial, sans-serif" font-size="32" font-weight="500">La visibilidad también se mide.</text>
  <line x1="84" y1="506" x2="996" y2="506" stroke="#86e7dc" stroke-opacity=".28"/>
...
sharp(report)
  ...
  .png()
  .toBuffer()
  .then(reportPng => sharp(Buffer.from(background)).composite([
    { input: reportPng, left: 72, top: 546 },
  ]).png().toFile(output))
