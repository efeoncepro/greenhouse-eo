...
| Publicidad y social con texto: posts, stories, reels, covers, banners, brochure, OOH, Bricolage/Poppins/Guttery | `efeonce-advertising-creative` + skill de formato | [`ADVERTISING_CREATIVE_AGENT_EXECUTION_V1.md`](docs/operations/ADVERTISING_CREATIVE_AGENT_EXECUTION_V1.md): AXIS posee valores/contrato; el agente prueba peso, espaciado, contraste, safe area y estado. No autoriza publicación. |
