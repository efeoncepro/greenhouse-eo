...
| Business model, packaging, pricing, unit economics | `efeonce-business-model-operator` + `efeonce-pricing-operator` + práctica dueña | `docs/business-models/README.md` + modelo vigente + Finance/Legal/Product según corresponda; `creative-practice` conserva la especialización Creative Studio |
