...
const source = D + '/sky-v13-picture-conformed.mp4';
...
const output = D + '/sky-v13-picture-final.mp4';
...
fs.writeFileSync(D + '/qa/composition.json', JSON.stringify({ sourceSha256: sha(source), outputSha256: sha(output), frames: index, titleOffset: 15.75, urlOffset: 26, urlWidth:320, urlMode: 'non-separable-luminosity', opacity: '1 on approved alpha containing original .72 and fade', audio: false, approvedSourceHashesVerified: true, samples, review: 'pending' }, null, 2));
