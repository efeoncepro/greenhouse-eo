...
import { compositeLuminosity } from '/Users/jreye/Documents/greenhouse-eo/scripts/creative/layout-compiler/compiler.mjs'

const DIR = '/Users/jreye/Documents/greenhouse-eo/ai-generations/2026-09-23_cmp003-sky-video/cierre'
...
for (const [name, [W, H, cy, urlTop]] of Object.entries(FORMATS)) {
  ...
  const out = path.join('/Users/jreye/Documents/greenhouse-eo/ai-generations/2026-09-23_cmp003-sky-video/seedance/v5/refs', `11-close-blue-${name}.png`)
