...
const OUT = '/Users/jreye/Documents/greenhouse-eo/ai-generations/2026-09-23_cmp003-sky-video/seedance/v11-full/refs'
...
const boards={
 '01-search-side-empty':depth(searchBox({text:'',cursor:true}), 'rotateY(-28deg) rotateX(5deg) scale(.85)',610),
 '02-search-side-question':depth(searchBox({text:Q,cursor:true}), 'rotateY(-28deg) rotateX(5deg) scale(.85)',610)
};
