...
**Cierre local de CMP001-04 · 2026-09-23.** El archivo de la carpeta sincronizada de OneDrive ya se pudo leer. Se respaldó la versión anterior en `01. Recursos/CMP-001 - Produccion y editables/historial/CMP001-04 - Sales tu - 9x16_pre-AXIS-2026-09-23.png` (SHA-256 `a7276ceb92e4b8c641f430983377878d5186200dbccc15b47103526793fcfa0e`) y se reemplazó sólo `03. Finales/.../9x16/CMP001-04 - Sales tu - 9x16.png` por `out/01-fuera-916.png`. La lectura local posterior dio el mismo SHA-256 que el export aprobado: `7a01d0d116f7c5231bde36c00930e61fcf574751969d76835b2376a4c1f39848`. La sincronización y el readback desde el servidor de OneDrive no se verificaron; no implica publicación ni pauta.

**Delta 2026-09-23 · lecho de «Que te elijan» (04-elegida-916).** El operador vio que en esta story la firma quedaba sobre el canto del lecho, no dentro de él como en las otras tres. Primer plano (lecho y apoyabrazos) subido 60 px del plate (69 px en la pieza) como una capa rígida, como con la cámara un poco más baja; el corte sigue el borde del propio objeto, con 10 px de fundido. Sin IA y sin deformar su forma. Script: `../2026-09-23_v07-lecho-04-elegida/subir-primer-plano-v4.cjs`. La firma no se mueve (caja 1619–1670 px, dentro de AXIS) y su contraste pasa de 6,53 a 11,58:1. El plate original sigue en `plates/04-elegida-916.png`; el nuevo es `plates/04-elegida-916-lecho.png`. Las otras 15 piezas son idénticas byte a byte. Aprobado por el operador; CMP001-07 reemplazada en OneDrive (la anterior, respaldada).
