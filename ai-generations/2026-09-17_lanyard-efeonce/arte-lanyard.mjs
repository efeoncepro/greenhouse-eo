...
// - Cinta: patrón repetido logo blanco · eslogan. «Empower your» va en gris CLARO #C8CEDA, no en el gris de marca
//   #848484: sobre navy ese gris no resuelve en serigrafía ni sublimado. «Growth» en blanco, como acento.
...
const eslogan = await sharp(Buffer.from(`<svg xmlns="http://www.w3.org/2000/svg" width="2200" height="${ALTO}">
  <text x="0" y="${Math.round(ALTO * 0.6)}" font-family="Poppins" font-size="${fs}" xml:space="preserve">
    <tspan fill="#C8CEDA" font-weight="800" font-style="italic">Empower</tspan><tspan fill="#C8CEDA" font-weight="800"> your </tspan><tspan fill="#ffffff" font-weight="900" font-style="italic">Growth</tspan>
