...
Territorio: Elección de fuente.

Dedo a punto de tocar fuente destacada; tensión del instante anterior al clic.

Palanca: instrumento en ficha original (clasificación incorrecta; corresponde revisar como manos).

## Estado y correcciones

No interpretar interfaz como captura real. Instrumento exige mirar a través: revisar clasificación sin reescribir prompt histórico.
