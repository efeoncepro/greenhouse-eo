# TASK-1345 / Wave diseno y desarrollo web — Landing Wireframe

## Meta

- Status: `draft`
- Owner task: `TASK-1345`
- Product Design asset: wireframe, flow/interlink map y HTML v11 importados desde la carpeta local `diseno-web` (2026-07-05). El HTML es referencia de implementacion, NO artefacto productivo aprobado.
...
- User moment: busca proveedor de diseno/desarrollo web o llega por interlink desde Wave/Efeonce. Sabe que necesita web, pero no necesariamente entiende SEO tecnico, AI-ready ni conversion infrastructure.
- Job to be done: entender por que Wave no entrega "una web linda" sino una superficie comercial medible, y pedir cotizacion sin friccion.
...
| 3.5 | CTA strip | Captura temprana sin interrumpir | Banda CTA | form/contacto |
| 4 | Niveles AI-ready | Escalera de madurez del sitio para IA | Ladder/cards | estatico |
...
> IDs con convencion public-site `public_site.wave_web.*`. Los textos son direccion de copy, no obligan a copiar literal si el runtime/voz pide ajuste. Todo claim de prueba queda `[verificar]`.

| Copy id | Region | Text | Dynamic values | Notes |
|---|---|---|---|---|
| `public_site.wave_web.hero.eyebrow` | 1 | Diseno y desarrollo web | — | categoria/eyebrow |
| `public_site.wave_web.hero.h1` | 1 | Sitios web que trabajan como infraestructura comercial. | — | idea fuerza |
| `public_site.wave_web.hero.subhead` | 1 | Disenamos y desarrollamos sitios rapidos, claros y preparados para SEO, performance e IA. No solo para que se vean bien: para que vendan, midan y puedan ser entendidos por buscadores, modelos y agentes. | — | adaptar a voz |
| `public_site.wave_web.hero.cta_primary` | 1 | Quiero cotizar | — | CTA principal |
| `public_site.wave_web.hero.cta_secondary` | 1 | Prefiero agendar una llamada | — | destino real `[verificar]` |
| `public_site.wave_web.hero.proof_1` | 1 | Estrategia + UX + desarrollo | — | proof chip |
| `public_site.wave_web.hero.proof_2` | 1 | SEO tecnico desde el build | — | proof chip |
| `public_site.wave_web.hero.proof_3` | 1 | AI-ready sin humo | — | proof chip |
| `public_site.wave_web.signature.h2` | 2 | Tu sitio ya no atiende a un solo visitante. | — | signature section |
| `public_site.wave_web.signature.human.title` | 2 | Visitantes humanos | — | panel |
| `public_site.wave_web.signature.human.body` | 2 | Necesitan entender rapido que haces, por que confiar y cual es el siguiente paso. | — | panel |
| `public_site.wave_web.signature.agent.title` | 2 | Buscadores, IA y agentes | — | panel |
| `public_site.wave_web.signature.agent.body` | 2 | Necesitan estructura, velocidad, schema, contenido claro y senales para interpretar tu negocio. | — | panel |
| `public_site.wave_web.idd.eyebrow` | 3 | Metodo IDD | — | metodo |
| `public_site.wave_web.idd.h2` | 3 | Investigar. Disenar y desarrollar. Desplegar y medir. | — | H2 |
| `public_site.wave_web.idd.investigar.title` | 3 | Investigar | — | step |
| `public_site.wave_web.idd.investigar.body` | 3 | Aclaramos el negocio, el cliente, las busquedas y la conversion antes de abrir el editor. | — | step |
| `public_site.wave_web.idd.disenar.title` | 3 | Disenar y desarrollar | — | step |
| `public_site.wave_web.idd.disenar.body` | 3 | Convertimos el mensaje en experiencia: arquitectura, UI, contenido, componentes y desarrollo. | — | step |
| `public_site.wave_web.idd.desplegar.title` | 3 | Desplegar y medir | — | step |
| `public_site.wave_web.idd.desplegar.body` | 3 | Dejamos la base lista para velocidad, indexacion, analytics, eventos y mejora continua. | — | step |
| `public_site.wave_web.mid_cta.h2` | 3.5 | Si tu sitio actual no explica, no convierte o no mide, partamos por ahi. | — | CTA strip |
| `public_site.wave_web.mid_cta.cta` | 3.5 | Quiero cotizar | — | CTA |
| `public_site.wave_web.ai_ready.h2` | 4 | Niveles AI-ready | — | ladder |
| `public_site.wave_web.ai_ready.body` | 4 | No todo sitio necesita una capa de IA el primer dia. Si necesita quedar estructurado para que motores, modelos y agentes lo puedan entender cuando llegue el momento. | — | evitar hype |
| `public_site.wave_web.ai_ready.level_1.title` | 4 | Visible | — | nivel |
| `public_site.wave_web.ai_ready.level_2.title` | 4 | Indexable | — | nivel |
| `public_site.wave_web.ai_ready.level_3.title` | 4 | Interpretable | — | nivel |
| `public_site.wave_web.ai_ready.level_4.title` | 4 | Accionable | — | nivel |
| `public_site.wave_web.ready.h2` | 5 | Sale listo para trabajar. | — | manifiesto |
| `public_site.wave_web.ready.body` | 5 | Un sitio Wave debe salir con base comercial, tecnica y analitica. No como maqueta bonita esperando que alguien mas la conecte. | — | adaptar |
| `public_site.wave_web.segments.h2` | 6 | Para que trabajo necesitas el sitio? | — | segmentacion |
| `public_site.wave_web.segments.scale.title` | 6 | Producir a escala | — | featured card |
| `public_site.wave_web.segments.scale.body` | 6 | Cuando necesitas landings, paginas de servicio o contenido reusable sin perder consistencia. | — | puede preselect form |
| `public_site.wave_web.performance.h2` | 7 | Performance habilitado desde el build. | — | feature grid |
| `public_site.wave_web.performance.body` | 7 | Velocidad, SEO tecnico, eventos, analytics y estructura no son extras: son parte del producto. | — | — |
| `public_site.wave_web.proof.h2` | 8 | Prueba antes que promesa. | — | proof |
| `public_site.wave_web.proof.body` | 8 | Casos, resultados y aprendizajes publicables se incorporan solo cuando esten verificados. | — | fallback honesto |
| `public_site.wave_web.derisk.h2` | 9 | Como reducimos el riesgo de comprar una web. | — | objections |
| `public_site.wave_web.faq.h2` | 10 | Preguntas frecuentes | — | FAQPage |
| `public_site.wave_web.form.h2` | 11 | Coticemos tu sitio | — | form |
| `public_site.wave_web.form.body` | 11 | Cuentanos que necesitas construir, mejorar o escalar. Te respondemos con el camino recomendado. | — | form intro |
...
- GVC markers: `hero`, `signature`, `idd`, `ai-ready`, `segments`, `performance`, `proof`, `faq`, `conversion-form`.
...
- Required captures: full-page, hero, IDD, AI-ready, segmentacion, proof, FAQ abierto, form/fallback.
...
- Decision: HTML v11 es referencia de implementacion porque ya contiene estructura y visual direction, pero se debe adaptar a runtime/patrones reales.
...
- Open risks: form final, proof publicable, Wave Hub/CRM/Think URLs.
