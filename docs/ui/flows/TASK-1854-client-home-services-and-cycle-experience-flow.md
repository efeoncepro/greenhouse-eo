# TASK-1854 — flujo cliente

Diseño inicial, sin runtime. Backend en sus tasks dueñas; UI no decide permisos.

## Surface Inventory

Inicio → servicio/período → pieza/revisión o Insights → retorno contextual.
...
3. Cambiar período conserva servicio; abrir pendiente/Insights resuelve su destino canónico.
