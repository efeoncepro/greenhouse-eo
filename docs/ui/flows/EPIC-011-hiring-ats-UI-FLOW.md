...
| **N10 Handoff/downstream** (reactivo, sin UI propia) | — (consume el evento) | handoff materializado · señales · bridges · cola internal_hire | reactive consumer + `HiringHandoff` (**356**) | 356 |
