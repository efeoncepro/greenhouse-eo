...
- Impact: `Muy alto`
- Effort: `Alto`
- Status real: `2026-09-07: emisor nativo y gateway multi-issuer productivos. TASK-1813 está completa: hardening 1.2.0 en 00047-8b5, rollback ensayado y Claude Code/Codex/Claude.ai/Claude Desktop/ChatGPT verdes post-cutover, base-only y sin gasto. TASK-1832 continúa su observación sintética hasta cleanup/readback cero y gates OFF; el primer cliente real permanece en TASK-1841. TASK-1844 queda registrada como U19 para el delta interno multiorganización, sin implementación ni rollout. El epic sigue abierto.`
- Rank: `TBD`
