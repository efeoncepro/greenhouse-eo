...
- Impact: `Muy alto`
- Effort: `Alto`
- Status real: `2026-09-07: emisor nativo y gateway multi-issuer productivos. TASK-1832 está en observación con helper/Playwright/Codex/ChatGPT hospedado verdes; Claude 2.1.263 tiene bootstrap mínimo y ceremonia pendiente. El cierre exige siete días, cleanup/readback cero y gates OFF; el primer cliente real permanece en TASK-1841. El epic sigue abierto.`
- Rank: `TBD`
...
Una sola task ejecutable posee cada unidad. `TASK-1836` es U11, `TASK-1837` es U12, `TASK-1838` es U13, `TASK-1839` es U14, `TASK-1840` es U15, `TASK-1841` es U16, `TASK-1842` es U17 y `TASK-1843` es U18; `TASK-659` y `TASK-658` permanecen relacionadas (ver
