...
| `TASK-1123` | `1.5` | `to-do` | Greenhouse AI Content Factory Agent Kit: AI-native but not chat-first; resources, recipes, catalogs, golden examples, validators and Full API Parity primitives so agents can generate Gutenberg post drafts and Elementor/Ohio landing drafts safely. MCP remains downstream of API Platform/primitives. |
