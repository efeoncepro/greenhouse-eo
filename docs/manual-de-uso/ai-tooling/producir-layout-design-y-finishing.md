...
7. **Compón determinísticamente.** Añade underlay óptico, hook, tipo, logo, CTA y legal desde fuentes y activos
   oficiales. No vuelvas a enviar la pieza compuesta al modelo.
