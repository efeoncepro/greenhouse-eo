...
- [Operar el motor de CTAs (foundation)](growth/operar-motor-cta.md) — crear/publicar/pausar CTAs gobernados por API admin o CLI, registrar surfaces con embed key (secreto una sola vez), seed canónico del primer CTA, estados del lifecycle, qué no hacer y troubleshooting (action no resoluble, forja, handoff roto). TASK-1339.
