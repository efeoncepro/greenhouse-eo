...
- [Fondear los créditos de Globe (propose → confirm)](creative-studio/fondear-creditos-globe.md) — el runbook del carril gobernado de fondeo mensual (TASK-1566/TASK-1616/ADR-015): OAuth PKCE por API, persona o agente autenticado con delegación acotada, dos claves de idempotencia, lectura del estado tras timeout y retiro de los scripts legacy de firma cliente.
