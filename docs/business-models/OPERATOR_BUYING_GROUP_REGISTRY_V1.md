...
| **Wave — Product Design 360** *(propuesta)* | **Head of Design / Design Director / Design Manager** — el líder de un equipo in-house que no llega | Una lane sale de su plato en el primer ciclo sin que él la supervise; recupera tiempo para el trabajo por el que quiere ser evaluado y pide la segunda lane | Head of Design (operador **y veto**); Head of Product o CPO (problem owner/sponsor); **Head of Engineering como governance owner**; economic buyer; Procurement/Legal | lanes activas, capacidad liberada declarada, OTD/FTR/RpA, first-time-right del handoff, drift diseño↔runtime, adopción del design system | `hypothesis_only` | Wave + Design; gates G1 y G2 del modelo económico — G2 valida que el Head of Design sea el comprador y no el veto; perfil **BP9 candidata** en `docs/context/13_icp-buyer-personas-jtbd.md` |
...
| **Media & Distribution — Performance & Commerce** *(propuesta 2026-09-10)* | Motion A: **Performance Lead o E-commerce Manager** · Motion B: **Demand Gen Manager o Marketing Ops** | A: lleva al CMO una recomendación de asignación con evidencia · B: lleva a ventas y al CMO pipeline con fuente CRM, no leads | A: CMO/Head of Growth/E-commerce; Finance; Legal (datos) · B: CMO/VP Marketing; líder comercial como co-sponsor; RevOps (governance de datos CRM); IT/Seguridad; Legal | señal de conversión, experimentos, recomendación de asignación ejecutada, pipeline con fuente (B) | `hypothesis_only` | Media & Distribution; validar con los pilotos de G1 de la [decisión](../architecture/EFEONCE_PERFORMANCE_COMMERCE_DISTRIBUTION_DECISION_V1.md) |
