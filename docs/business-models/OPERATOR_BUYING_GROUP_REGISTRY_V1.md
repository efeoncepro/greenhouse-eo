...
| **Wave — Product Design 360** *(propuesta)* | Product Manager / Product Owner; Digital o Web Lead en superficies de marketing | Un flujo rediseñado llega a producción y mueve una métrica que el operador ya reportaba; entonces pide la superficie siguiente sin que se la ofrezcan | Head of Product o Gerente de Marketing Digital (problem owner); CPO/CTO/CMO (sponsor); **Head of Engineering como governance owner y bloqueador real**; economic buyer; Procurement/Legal | hallazgos priorizados, decisiones habilitadas, superficies llegadas a producción, drift diseño↔runtime, adopción del design system | `hypothesis_only` | Wave + Design; validar con el gate G1 del modelo económico |
