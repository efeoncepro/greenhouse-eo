...
7. El cierre `implemented` exige ruta runtime y evidencia gobernada (`gvc_capture`, `runtime_route` o excepcion manual auditada).
...
- Test focal: `pnpm exec vitest run src/lib/design-system/handoff/store.test.ts`.
