...
- **Se contrata por organización, no por rol.** La capacidad se habilita asignando el módulo `proposal_studio_v1` a la organización. Sin esa asignación, nadie —ni un administrador— puede operar propuestas. Hoy no está asignado en ningún ambiente: el dominio está apagado hasta completar la verificación en staging.
