...
| `TASK-055` | [TASK-055-finance-intelligence-cost-coverage-repair.md](in-progress/TASK-055-finance-intelligence-cost-coverage-repair.md) | P1 | Muy alto | Alto | Avanzada | Pipeline `client_economics` reparado. Faltan: tests unitarios de completitud y bridge, edge case FX precision |
| `TASK-064` | [TASK-064-ico-assignee-attribution-remediation.md](in-progress/TASK-064-ico-assignee-attribution-remediation.md) | P0 | Muy alto | Alto | Avanzada | Atribuciones remediadas y funcionando. Faltan: guardrail operativo de cobertura, docs arquitectónicas |
...
| `TASK-079` | [TASK-079-payroll-chile-reverse-calculation-engine.md](to-do/TASK-079-payroll-chile-reverse-calculation-engine.md) | P0 | Muy alto | Alto | Diseño | **[4/4]** Motor reverse `gross from net` + preview por líquido deseado. Depende de TASK-078 + TASK-076. |
