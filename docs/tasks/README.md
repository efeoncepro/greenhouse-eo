...
- siguiente ID disponible: `TASK-090`
...
| 4    | `TASK-089`                                                                                               | [TASK-089-payroll-ux-semantics-and-feedback-hardening.md](to-do/TASK-089-payroll-ux-semantics-and-feedback-hardening.md) | P1 | Alto | Medio | Parcial | Separar período actual/histórico/proyectado y robustecer feedback, accesibilidad y copy de Payroll |
| 5    | `TASK-063`                                                                                               | [TASK-063-payroll-projected-payroll-runtime.md](to-do/TASK-063-payroll-projected-payroll-runtime.md)                   | P1 | Alto | Alto | Diseño | Baseline de nómina proyectada, snapshots serving, as_of_date y proyección reactiva |
