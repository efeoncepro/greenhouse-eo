...
| `TASK-076` | [TASK-076-payroll-chile-liquidacion-parity.md](to-do/TASK-076-payroll-chile-liquidacion-parity.md) | P0 | Muy alto | Alto | Diseño | Paridad con liquidación legal chilena: gratificación legal, colación, movilización, AFP desglosada, isapre desglosada, costos empleador (SIS, cesantía, mutual), RUT, datos bancarios |
| `TASK-077` | [TASK-077-payroll-receipt-generation-delivery.md](to-do/TASK-077-payroll-receipt-generation-delivery.md) | P1 | Muy alto | Alto | Diseño | Generación automática de recibos PDF al exportar, storage GCS, email via Resend con adjunto, acceso en Mi Nómina, formato Chile legal + Internacional |
| `TASK-078` | [TASK-078-payroll-chile-reverse-calculation-engine.md](to-do/TASK-078-payroll-chile-reverse-calculation-engine.md) | P0 | Muy alto | Alto | Diseño | Motor de cálculo inverso: dado líquido deseado, calcular bruto, AFP, salud, cesantía, impuesto automáticamente. Catálogo AFP con tasas, indicadores previsionales automáticos (IMM, topes UF) |
