...
| `TASK-078` | [TASK-078-payroll-chile-reverse-calculation-engine.md](to-do/TASK-078-payroll-chile-reverse-calculation-engine.md) | P0 | Muy alto | Alto | Diseño | **[1/3]** Sync Previred via Gael Cloud API + reverse engine + forward cutover a indicadores synced + wiring reactivo. Ejecutar primero. |
| `TASK-076` | [TASK-076-payroll-chile-liquidacion-parity.md](to-do/TASK-076-payroll-chile-liquidacion-parity.md) | P0 | Muy alto | Alto | Diseño | **[2/3]** Campos legales: gratificación, colación, movilización, AFP/isapre desglose, costos empleador, RUT. Depende de TASK-078. |
| `TASK-077` | [TASK-077-payroll-receipt-generation-delivery.md](to-do/TASK-077-payroll-receipt-generation-delivery.md) | P1 | Muy alto | Alto | Diseño | **[3/3]** Recibos PDF + email Resend + Mi Nómina. Depende de TASK-076. |
