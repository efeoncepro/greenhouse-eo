...
| 46 | `TASK-119` | [TASK-119-home-landing-rollout-navigation-cutover.md](to-do/TASK-119-home-landing-rollout-navigation-cutover.md) | P1 | Alto | Medio | Diseño | Rollout final de `/home`: policy de landing, `portalHomePath`, sidebar y reubicación clara de `Control Tower` |
