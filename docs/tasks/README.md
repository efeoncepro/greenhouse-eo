...
| `TASK-079` | [TASK-079-payroll-chile-reverse-calculation-engine.md](in-progress/TASK-079-payroll-chile-reverse-calculation-engine.md) | P0 | Muy alto | Alto | Implementación parcial | **[4/4]** Motor reverse `gross from net` (Slice 1 cerrado: engine + 10 golden tests). Falta: preview UI (Slice 2) y validación con caso real (Slice 3). |
