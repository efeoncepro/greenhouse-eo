...
| ---------- | -------------------------------------------------------------------------------------------------------- | --------- | ------- | -------- | ----------- | ----------------------------------------------------------------------------------------------------------------------- |
| `TASK-077` | [TASK-077-payroll-receipt-generation-delivery.md](in-progress/TASK-077-payroll-receipt-generation-delivery.md) | P1 | Muy alto | Alto | En progreso | **[3/4]** Recibos PDF + email Resend + Mi Nómina. Depende de TASK-076. |
...
| [TASK-077-payroll-receipt-generation-delivery.md](in-progress/TASK-077-payroll-receipt-generation-delivery.md) | Generación y entrega de recibos de nómina: PDFs por entry, storage GCS, email Resend, surfaces People/Mi Nómina |
