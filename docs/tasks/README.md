...
| 9 | [CODEX_TASK_Nubox_DTE_Integration.md](to-do/CODEX_TASK_Nubox_DTE_Integration.md) | P1 | Alto | Medio | Diseño | Integración bidireccional Nubox ↔ Finance: emisión DTE, sync ventas/compras/pagos, reconciliación SII |
