...
| `TASK-079` | [TASK-079-payroll-chile-reverse-calculation-engine.md](in-progress/TASK-079-payroll-chile-reverse-calculation-engine.md) | P0 | Muy alto | Alto | Implementación (7/8 AC) | **[4/4]** Motor reverse completo: engine + preview + hardening + validación con caso real. Pendiente: round-trip check (nice-to-have). |
