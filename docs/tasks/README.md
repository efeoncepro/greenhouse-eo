...
| 2    | `TASK-056`                                                                                               | [TASK-056-agency-team-capacity-semantics.md](to-do/TASK-056-agency-team-capacity-semantics.md)                           | P1        | Alto     | Medio             | Diseño                                                                                                               | Formalizar el contrato de `Agency > Team`: separar capacidad comercial, uso operativo y helper reusable de unidades `FTE <-> horas`                                                     |
