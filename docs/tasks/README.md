...
| `TASK-119` | [TASK-119-home-landing-rollout-navigation-cutover.md](in-progress/TASK-119-home-landing-rollout-navigation-cutover.md) | P1 | Alto | Medio | Implementación parcial | Rollout de `/home` ya arrancó: fallback interno a `/home`, Home como entrada principal y `Control Tower` reubicado como surface especialista; falta validación manual en staging |
...
| 25   | `TASK-019`                                                                                               | [TASK-019-staff-augmentation-module.md](to-do/TASK-019-staff-augmentation-module.md)                                       | P2        | Alto     | Alto              | Diseño                                                                                                               | Placements de staff aug sobre assignments, people y services                                                                                                                            |
...
| 46 | `TASK-119` | [TASK-119-home-landing-rollout-navigation-cutover.md](in-progress/TASK-119-home-landing-rollout-navigation-cutover.md) | P1 | Alto | Medio | Implementación parcial | Rollout final de `/home`: policy de landing, `portalHomePath`, sidebar y reubicación clara de `Control Tower` |
| 47 | `TASK-120` | [TASK-120-admin-center-governance-follow-on-cutover.md](to-do/TASK-120-admin-center-governance-follow-on-cutover.md) | P2 | Medio | Bajo | Diseño | Follow-on de `Admin Center`: role scoping fino, deep-link con surfaces especialistas y bundle de verificación |
