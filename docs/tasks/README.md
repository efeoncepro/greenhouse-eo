...
| `TASK-058` | [TASK-058-economic-indicators-runtime-layer.md](in-progress/TASK-058-economic-indicators-runtime-layer.md) | P1        | Alto    | Medio    | Diseño      | Capa común de indicadores económicos (`USD_CLP`, `UF`, `UTM`, `IPC`), histórico desde `2026-01-01`, sync diario y refresh reactivo de consumers derivados |
