...
| `TASK-772` | `to-do` | Finance Expense Supplier Hydration & Cash-Out Selection Integrity (corrige obligaciones con `supplierId` válido pero `supplierName=NULL`, visibilidad/sort en Compras, agrupación de Registrar pago y separación monto original vs CLP; caso Figma `EXP-202604-008`) | `docs/tasks/to-do/TASK-772-finance-expense-supplier-hydration-cash-out-selection.md` |
