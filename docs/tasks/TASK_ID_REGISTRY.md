...
| `TASK-811` | `to-do` | Copy Migration: greenhouse-nomenclature.ts Domain Microcopy Trim (originalmente Slice 7 de TASK-407 según Delta 2026-05-02; ID corregido 2026-05-06 — TASK-409 está burned por payroll-reliquidation-program). Bloqueada por TASK-407 + TASK-408 cerradas. | `docs/tasks/to-do/TASK-811-greenhouse-nomenclature-domain-microcopy-trim.md` |
