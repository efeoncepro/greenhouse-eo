...
| `TASK-890` | `to-do` | Workforce Exit Payroll Eligibility Window — contrato canonico para que Offboarding, Nomina proyectada/oficial y Person 360 compartan ventana de salida, cierre con proveedor auditado y deteccion de drift de relacion legal. | `docs/tasks/to-do/TASK-890-workforce-exit-payroll-eligibility-window.md` |
