...
| `TASK-769` | `in-progress` | Cloud Cost Intelligence + AI FinOps Copilot (Billing Export V2 + resource drill-down + deterministic spike detection + AI grounded interpretation + alert routing portal-first) | `docs/tasks/in-progress/TASK-769-cloud-cost-intelligence-ai-finops-copilot.md` |
