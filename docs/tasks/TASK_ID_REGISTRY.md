...
| `TASK-766` | `to-do` | Finance CLP-Currency Reader Contract Resilience (VIEW expense_payments_normalized + helper canónico + lint rule no-untokenized-fx-math + reliability signal + repair endpoint + recovery del bug KPIs inflados 88× 2026-05-02) | `docs/tasks/to-do/TASK-766-finance-clp-currency-reader-contract.md` |
