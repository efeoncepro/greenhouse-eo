...
| `TASK-877` | `to-do` | Workforce Activation External Identity Reconciliation — integra Workforce Activation con Identity Reconciliation para resolver vínculos externos requeridos, empezando por Notion, mediante candidatos/evidencia/audit y sin escribir IDs manuales. | `docs/tasks/to-do/TASK-877-workforce-external-identity-reconciliation.md` |
