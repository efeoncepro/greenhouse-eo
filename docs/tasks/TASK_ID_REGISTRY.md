...
| `TASK-589` | `in-progress` | Finance Read Path Provisioning Decoupling & Directory Hardening | `docs/tasks/to-do/TASK-589-finance-runtime-read-path-decoupling-clients-suppliers.md` |
