...
| `TASK-874` | `to-do` | Workforce Activation Readiness Resolver + Workspace — follow-up de TASK-872/TASK-873 para crear readiness canónico por carriles, bloquear `complete-intake` si hay blockers reales, enriquecer la queue con next actions, agregar signals y manual HR sin duplicar ownership de People/HR/Payroll/Finance/Legal Profile. | `docs/tasks/to-do/TASK-874-workforce-activation-readiness-workspace.md` |
