...
| `TASK-884` | `to-do` | Ecosystem Access Control Plane Architecture — ADR/spec para que Greenhouse gobierne desired access state del ecosistema Efeonce, permitiendo provisioning local en Kortex/Verk pero con drift, approvals y reconciliacion central. | `docs/tasks/to-do/TASK-884-ecosystem-access-control-plane-architecture.md` |
