...
- Blocked by: `TASK-1465`
- Branch: `task/TASK-1466-globe-operating-modes-responsibility-contract`
- Legacy ID: `none`
- GitHub Issue: `none`

## Summary

Modelar client-operated, co-operated y efeonce-managed mediante asignaciones explícitas de responsabilidad, entitlements y contexto comercial inmutable.
...
- Boundary: `Globe Operating Modes and Responsibility Contract`
