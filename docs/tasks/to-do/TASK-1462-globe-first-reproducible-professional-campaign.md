# TASK-1462 — Globe First Reproducible Professional Campaign
...
Producir una campaña profesional reproducible de idea a release con set digital y off-branding, combinando modelos según fortalezas en vez de compararlos uno a uno.
...
Demostrar craft, método, formatos y trazabilidad end-to-end sobre un mismo sistema.
...
- Boundary: `Globe First Reproducible Professional Campaign`
...
- Cerrar dirección creativa, layout masters y asset authority.
...
- Empaquetar masters, manifests, QA, costs y retrospectiva reproducible.
...
La ejecución comienza desde Greenhouse con `pnpm codex:task-hook TASK-1462 --develop` cuando el operador apruebe su goal. El plan puede modificar el repositorio hermano en los paths owned, pero lifecycle, checkpoints, QA y cierre permanecen en esta spec canónica.
...
|---|---|---|---|---|
| Demo vistosa pero artesanal e irrepetible | Globe/Greenhouse | medium | gate binario, allowlist, audit y rollback antes de ampliar | pieza sin master o pasos manuales ocultos |
