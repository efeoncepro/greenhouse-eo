...
## Acceptance Criteria
- [ ] Tabla `greenhouse_serving.finance_ai_signals` existe con datos
- [ ] Detector genera señales para anomalías de margen y cash flow
- [ ] Enrichments LLM con prompt financiero producen narrativas relevantes
- [ ] Finance Dashboard muestra `NexaInsightsBlock` con insights financieros
