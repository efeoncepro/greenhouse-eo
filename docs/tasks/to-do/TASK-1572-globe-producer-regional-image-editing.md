...
- Para la UI de esta task: el nivel «Preciso» sólo puede ofrecerse si el runtime de `TASK-1497` entrega la evidencia de
  esa composición (delta máximo 0 fuera de la máscara). Sin ella, el resultado se presenta como preservación natural,
  nunca como exacta.
