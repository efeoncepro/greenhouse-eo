# TASK-1471 — Globe Layout Compiler and Deterministic Finishing
...
- Rank: `TBD`
- Domain: `creative|design|platform`
- Blocked by: `TASK-1462, TASK-1467, TASK-1470`
- Branch: `task/TASK-1471-globe-layout-compiler-deterministic-finishing`
- Legacy ID: `none`
- GitHub Issue: `none`

## Summary

Convertir decisiones creativas aprobadas en templates curados, layout masters y finishing determinista para adaptar campañas sin perder estándar visual.
...
Combinar riqueza generativa con control compositivo, tipográfico y de formatos.
...
- Boundary: `Globe Layout Compiler and Deterministic Finishing`
...
- Versionar creative brief, composition intent y template contract.

### Slice 2

- Compilar layout masters a formatos digital/off.

### Slice 3

- Aplicar finishing determinista, safe zones, color, typography y export QA.
...
La ejecución comienza desde Greenhouse con `pnpm codex:task-hook TASK-1471 --develop` cuando el operador apruebe su goal. El plan puede modificar el repositorio hermano en los paths owned, pero lifecycle, checkpoints, QA y cierre permanecen en esta spec canónica.
...
|---|---|---|---|---|
| Consistencia visual rota entre formatos | Globe/Greenhouse | medium | gate binario, allowlist, audit y rollback antes de ampliar | derivado sin layout master/version |
