# TASK-1477 — Globe Buyer Discovery and Package Comprehension
...
Validar con compradores la taxonomía capacidad × dirección × memoria, los modos operativos y la comprensión de paquetes sin fijar aún pricing público.
...
Saber qué compran, qué confunden y qué evidencia necesitan antes de pilotear.
...
- Boundary: `Globe Buyer Discovery and Package Comprehension`
...
- Definir guion y muestra de perfiles compradores.

### Slice 2

- Ejecutar entrevistas/demos con evidencia y consentimiento.

### Slice 3

- Sintetizar decisiones, objeciones y cambios de paquete.
...
La ejecución comienza desde Greenhouse con `pnpm codex:task-hook TASK-1477 --develop` cuando el operador apruebe su goal. El plan puede modificar el repositorio hermano en los paths owned, pero lifecycle, checkpoints, QA y cierre permanecen en esta spec canónica.
...
|---|---|---|---|---|
| Diseñar oferta por intuición interna | Globe/Greenhouse | medium | gate binario, allowlist, audit y rollback antes de ampliar | package decision sin research evidence |
