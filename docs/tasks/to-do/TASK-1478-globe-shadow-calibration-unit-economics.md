...
Calibrar Studio Credits, costo, latencia, rework y margen mediante 30–50 runs shadow representativos y reconciliados.
...
Validar unit economics antes de exponer precios, wallets o promesas de volumen.
...
- `TASK-1468`, `TASK-1469`, `TASK-1470`, `TASK-1471`, `TASK-1472`.
...
- Boundary: `Globe Shadow Calibration and Unit Economics`
...
- Definir muestra estratificada y reglas de exclusión.

### Slice 2

- Ejecutar/reconciliar runs con route, attempts, labor y delivery outcome.
...
La ejecución comienza desde Greenhouse con `pnpm codex:task-hook TASK-1478 --develop` cuando el operador apruebe su goal. El plan puede modificar el repositorio hermano en los paths owned, pero lifecycle, checkpoints, QA y cierre permanecen en esta spec canónica.
...
|---|---|---|---|---|
| Precio basado en promedio engañoso | Globe/Greenhouse | medium | gate binario, allowlist, audit y rollback antes de ampliar | run excluido sin reason |
