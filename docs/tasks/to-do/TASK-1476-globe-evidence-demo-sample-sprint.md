# TASK-1476 — Globe Evidence-backed Demo and Sample Sprint
...
Empaquetar evidencia real en un demo kit y un Sample Sprint Efeonce-managed con alcance, responsabilidades, derechos y criterios de éxito explícitos.
...
Permitir demostrar y vender capacidad creativa gobernada sin prometer Studio Access.
...
- Boundary: `Globe Evidence-backed Demo and Sample Sprint`
...
- Definir demo verificable desde la campaña reproducible.

### Slice 2

- Diseñar Sample Sprint managed con intake, scope, gates y handoff.

### Slice 3

- Preparar evidencia de calidad, tiempos, credits shadow y límites.
...
La ejecución comienza desde Greenhouse con `pnpm codex:task-hook TASK-1476 --develop` cuando el operador apruebe su goal. El plan puede modificar el repositorio hermano en los paths owned, pero lifecycle, checkpoints, QA y cierre permanecen en esta spec canónica.
...
|---|---|---|---|---|
| Sobrepromesa comercial antes del readiness | Globe/Greenhouse | medium | gate binario, allowlist, audit y rollback antes de ampliar | claim sin artifact/run evidence |
