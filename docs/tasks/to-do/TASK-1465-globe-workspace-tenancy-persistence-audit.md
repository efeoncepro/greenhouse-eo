...
- Definir schema y migrations tenant-scoped.

### Slice 2

- Implementar command/reader layer con auth e idempotencia.

### Slice 3

- Agregar audit/outbox y pruebas de aislamiento.
