...
- 2026-06-14 follow-up: `greenhouse-wp-bridge` v0.2.0 adds read-only Gutenberg/block inspection at `GET /wp-json/greenhouse-wp-bridge/v1/inspection/block-document/{id}`. Smoke for post `249766` (`GLITCH #02`) returned health `200`, Elementor summary empty, block document `200`, `model=wordpress_blocks`, `hasBlocks=true`, `elementorDataPresent=false`, 81 parsed blocks and bounded top-level sample. Evidence: `docs/operations/public-site-bridge-inspections/inspection-page-249766-2026-06-14T16-46-47-906Z.json`.
- Fresh live export after v0.2.0 deploy: `tmp/public-site-code-baselines/2026-06-14T16-47-46-557Z/`, 57 files observed. Drift evidence `docs/operations/public-site-drift/drift-2026-06-14T16-47-57-837Z.json`: `in_sync=55`, `ignored_live=2`, `drifted=0`, `repo_missing=0`, `repo_extra=0`. Dry-run `docs/operations/public-site-deploy-dry-runs/dry-run-2026-06-14T16-47-57-837Z.json`: `noop=55`, `would_create=0`, `would_update=0`. Status `docs/operations/public-site-runtime-status/status-2026-06-14T16-48-04-143Z.json` still shows runtime repo dirty until the v0.2.0 runtime commit is made.
