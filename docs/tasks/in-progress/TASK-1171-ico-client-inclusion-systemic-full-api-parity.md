...
**Pendiente:** Slice 3 (capability+endpoint gobernado enable-sync/verify-ICO, Nexa-operable — la pieza que hace el ONBOARDING escalable sin código), Slice 4 (preflight/lifecycle a ICO), Slice 5 (UI). (Staleness del período vigente: RESUELTA en Slice 1b. Agency report: RESUELTO en Slice 2.)
