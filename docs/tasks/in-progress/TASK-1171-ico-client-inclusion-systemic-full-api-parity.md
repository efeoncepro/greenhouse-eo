...
**Pendiente:** Slice 2 (agency report data-driven), Slice 3 (capability+endpoint gobernado Nexa-operable), Slice 4 (preflight/lifecycle a ICO), Slice 5 (UI). (Staleness del período vigente: RESUELTA en Slice 1b.)
