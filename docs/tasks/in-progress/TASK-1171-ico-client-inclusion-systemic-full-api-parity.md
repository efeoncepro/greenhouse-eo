...
**Pendiente:** Slice 5 (preflight/verify-ICO profundo "configurado ≠ fluyendo" + lifecycle a ICO + UI affordance). (Staleness: RESUELTA Slice 1b. Agency report: RESUELTO Slice 2. Enable-sync gobernado: RESUELTO Slice 3. Propagación BQ reactiva: RESUELTA Slice 4.)
