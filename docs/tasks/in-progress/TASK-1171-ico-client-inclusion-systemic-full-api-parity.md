...
**Pendiente:** Slice 4 (reactive consumer del outbox `space_notion_source.ico_sync_enabled` → BQ MERGE desde ops-worker + preflight/verify-ICO profundo "configurado ≠ fluyendo" + lifecycle a ICO), Slice 5 (UI affordance). (Staleness: RESUELTA Slice 1b. Agency report: RESUELTO Slice 2. Enable-sync gobernado: RESUELTO + endpoint verificado live Slice 3.)
