...
**Reframe transversal (corrección del operador, misma sesión):** la primera promoción arrastró el marco "sobre Knowledge" del mockup original (Knowledge era la primera superficie real). El operador lo frenó — la experiencia es una **capacidad TRANSVERSAL**, no "de Knowledge" (hard rule de la task). Reframe **copy-only** (sin tocar la experiencia → la mecánica/paridad intactas): hero "Nexa Answers **sobre Knowledge**" → "Nexa Answers **Experience**" + body que describe la capacidad transversal; ContextStrip → "Experiencia transversal · La respuesta se arma · Host vivo · Citas al dato real"; sección principal "Surface embebida" → "La respuesta lidera y se arma" con caption **"Ejemplo: Knowledge"**; "Portabilidad fuera de Knowledge" → "El mismo canvas, cualquier dominio"; "AI moment" rail + "Coreografía" → domain-neutral; chip **"Ejemplo: Knowledge"** en la sección de composición. Knowledge queda como **un ejemplo etiquetado** par de Finance/Insight bajo un marco neutral. Validado con `greenhouse-ux-writing` (es-CL, sentence case, sin sobrevender) + GVC mirado. eslint 0 · tsc 0.
