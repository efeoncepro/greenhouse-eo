...
4. Producción: repetir 1–3 con cooldown de 24 h; `auth.efeonce.org` con certificado managed `ACTIVE`; canary del gateway `mcp.efeonce.org` verde después del apply. — **HECHO 2026-09-04** (release `9100bbd2765d`; el cooldown de 24 h se sustituyó por la decisión del operador de promover el mismo día; verificación en vivo 16:49Z).
5. Señales steady 7 días. — pendiente (ventana 2026-09-04 → 2026-09-11).
