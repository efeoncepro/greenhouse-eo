...
- Type: `implementation`
- Epic: `optional`
- Status real: `Cerrada 2026-04-29 — Cash Position consume Banco como contrato read-only, agrega helper ledger-first, fallback seguro con amount_clp, UI semantica y tests de regresion. Banco no fue modificado.`
- Rank: `TBD`
- Domain: `finance`
- Blocked by: `none`
