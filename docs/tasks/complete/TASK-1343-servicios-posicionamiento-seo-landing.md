...
- Corrección post-feedback de marca en E-E-A-T: se retiró el intento temporal con `simple-icons` monocromo y el panel `Peso de E-E-A-T` ahora usa assets locales reales: `.gh-google-dark-mark` contiene el SVG multicolor local de Google en soporte compatible con fondo oscuro, y `.gh-chatgpt-mark` contiene el isotipo GPT local (`public/images/logos/axis/gpt-isotype.svg`) en lugar del sparkle. Backup de esta corrección: `_gh_backup_before_task1343_seo_landing_20260706T215458Z`.
...
- E-E-A-T brand assets Playwright live: `.captures/task1343-seo-eeat-google-chatgpt-assets-2026-07-06T21-56-52-259Z/`; `.gh-google-dark-mark svg` presente con viewBox `0 0 256 262` y fills Google `#4285F4/#34A853/#FBBC05/#EB4335`; `.gh-chatgpt-mark svg` presente con viewBox del asset GPT local `0 0 45.9894 47.0006`; sin `ti-brand-google` en `En SEO clásico`, sin `ti-sparkles` en `En AEO / IA`, sin path temporal `simple-icons`, desktop/mobile sin overflow.
