...
- **Click en fila:** Toda la fila es clickeable y navega al detalle del tenant (la vista que ya rediseñamos en `docs/tasks/complete/CODEX_TASK_Tenant_Detail_View_Redesign.md`).
