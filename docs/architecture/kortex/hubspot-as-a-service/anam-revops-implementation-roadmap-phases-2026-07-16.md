...
| 3. Service and contract portfolio | Represent each awarded service after the Deal is won. | Approved Service dictionary and no-write Deal/line-item-to-Service dry run. | In progress: dedicated Service group + 10 properties are live/read back and calculated propagation passed; first forward records remain pending; historical migration is `NO-GO`. |
