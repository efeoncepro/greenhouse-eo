...
| 3. Service and contract portfolio | Represent each awarded service after the Deal is won. | Approved Service dictionary, controlled pilot and activation review. | In progress: group + 10 properties, association labels and five controlled `New` Services are live/read back; all remain `incomplete_core`, activation review is pending and historical migration is `NO-GO`. |
...
The panel-first contract and live no-write evidence are documented in [`anam-phase-3-panel-first-service-readiness-2026-07-16.md`](anam-phase-3-panel-first-service-readiness-2026-07-16.md). The governed award/activation gates, TCV/ARR semantics and minimal property design are documented in [`anam-phase-3-forward-service-capture-contract-2026-07-16.md`](anam-phase-3-forward-service-capture-contract-2026-07-16.md). The dedicated Service group and ten properties are live/read back, and calculated readiness propagated to `incomplete_core` on the sample without a record write. The historical cohort still has zero fully migration-ready line items without inference, so the next record execution is a separately approved 3–5-record forward pilot—not bulk backfill.

The five-row simulation in [`anam-phase-3-forward-pilot-dry-run-2026-07-16.md`](anam-phase-3-forward-pilot-dry-run-2026-07-16.md) proved the award projection. With a separate operator approval, those exact rows became the controlled pilot recorded in [`anam-phase-3-forward-pilot-execution-2026-07-16.md`](anam-phase-3-forward-pilot-execution-2026-07-16.md). They remain `New` and `incomplete_core`; they are QA inputs, not an official portfolio cohort or authorization for backfill.
