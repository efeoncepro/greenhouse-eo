...
|---|---|---|---|
| 0. Customer Agent and landing | Resolve documented demand and gather context before human handoff. | Live landing, Emma, Markdown knowledge, QA and routing workflow `1876744588`. | Operativo: canal y landing live; handoff por intención/disponibilidad verificado el 2026-09-01. La respuesta humana y una segunda reasignación en el mismo chat siguen sin prueba runtime. |
...
| 6. Tickets and operational cases | Connect customer cases to the right Company, Contact and Service. | Ticket taxonomy, routing, SLA, resolution and Customer Agent escalation evidence. | El routing acotado de Customer Agent está operativo; la taxonomía, asociaciones, SLA y resolución integral siguen planificados después de las bases comerciales. |
