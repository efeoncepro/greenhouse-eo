...
| 3. Service and contract portfolio | Represent each awarded service after the Deal is won. | Approved Service dictionary and no-write Deal/line-item-to-Service dry run. | In progress: group + 10 properties are live, propagation passed and five-row award-gate simulation passed; activation evidence and first real forward record remain pending; historical migration is `NO-GO`. |
...
The five-row historical simulation in [`anam-phase-3-forward-pilot-dry-run-2026-07-16.md`](anam-phase-3-forward-pilot-dry-run-2026-07-16.md) proves the award projection can derive identity, Company, Product/family, currency, TCV, ARR provenance and a proposed owner. All five fail activation because dates, revenue model, renewal facts and delivery status are absent. They remain simulation rows and must not be created as backfill.
