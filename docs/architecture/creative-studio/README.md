...
- [EFEONCE_GLOBE_STORYBOARD_STUDIO_V1.md](EFEONCE_GLOBE_STORYBOARD_STUDIO_V1.md) — **SPEC-012**: aggregates y revisiones, colaboración/mentions/anotaciones, proposal workflow, mixed-origin realization, handoffs Producer/Video Effectiveness, acceso/retención, Structured Sequence Canvas, exports y plan TASK-1543…1549.
