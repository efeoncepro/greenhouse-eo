...
el halo editable. **Omitir la máscara de escena** hace que el modelo re-dibuje la escena completa conservando el objeto:
...
halo enmascarado, además medir la diferencia en la zona protegida. En una pieza, la firma sigue siendo el SVG oficial
compuesto. Registro:
