...
| 12 | MCP Greenhouse: inventario de tools y cómo usarlo | manual | `manual-de-uso/plataforma/mcp-greenhouse-tool-inventory.md` | platform | efeonce_admin | agent_allowed |
