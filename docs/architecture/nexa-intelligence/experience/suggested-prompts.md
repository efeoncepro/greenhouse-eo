...
TASK-1078 (Tier 1/1.5 — floating chat + `NexaContextScope`) · **TASK-1087 (Tier 2 — data-aware)** · **TASK-1139 (Tier 2.1 — hint UI + entrypoint + cache)** · **TASK-1141 (registry + contexto `personal`)**.
