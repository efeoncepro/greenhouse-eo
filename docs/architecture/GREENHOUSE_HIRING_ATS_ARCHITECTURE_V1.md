...
- **Rollout:** migraciones `20260713165547000` + hardening `20260713173500000` aplicadas en Cloud SQL dev y smoke sintético verde. Staging/prod quedan bloqueados por revisión legal/privacidad, categorías definitivas, consentimiento/copy final, retención y configuración/flag. No hay backfill: la cohorte es prospectiva.
