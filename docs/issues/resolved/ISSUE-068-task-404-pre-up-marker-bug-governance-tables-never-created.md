...
Resolved (Fases 1-4 entregadas 2026-05-08 vía TASK-838; Fase 5 registrada en TASK-839; Fase 6 registrada en TASK-840).
...
- **Fase 5 (deferred)** — Wire Admin Center mutation paths. Registrada como **TASK-839** (P2, Effort Alto, 1-2 días, UX-heavy). No bloqueante: la infraestructura DB + observability + CI gate ya están en su lugar. Spec: `docs/tasks/to-do/TASK-839-issue-068-fase-5-admin-center-governance-wire-up.md`.
- **Fase 6 (oportunista)** — Cleanup capabilities deprecated. Registrada como **TASK-840** (P3, housekeeping, blocked by TASK-839). Spec: `docs/tasks/to-do/TASK-840-issue-068-fase-6-deprecated-capabilities-cleanup.md`.
