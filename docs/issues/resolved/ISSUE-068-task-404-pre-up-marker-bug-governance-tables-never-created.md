...
- **Fase 5 (cerrada 2026-05-11)** — Wire Admin Center mutation paths. **TASK-839** cerró capabilities granulares `access.governance.*`, endpoints `/api/admin/entitlements/**`, segunda firma para grants sensibles, fan-out reactive y signals `identity.governance.*`. Spec: `docs/tasks/complete/TASK-839-issue-068-fase-5-admin-center-governance-wire-up.md`.
