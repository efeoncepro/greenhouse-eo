...
<!-- changelog-entry-sha256:40725875ef7f7e6fb72aa4b6f076c9c7fc1d07ce342c8b4b2bf48cd35dc146b6 -->
...
propertyChange no llegó y se re-upsertó con el helper canónico del webhook (`batchReadServices` + `upsertServiceFromHubSpot`;
el bridge Cloud Run devuelve 404 en `/companies/{id}/services`). Términos `7c38b899…` (committed, CLP 3.000.000,
