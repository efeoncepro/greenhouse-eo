...
| `efeonce-content-marketing` | quote_request | Conversación de Content Marketing | `/servicio-marketing-de-contenidos/` · `fhsf-efeonce-content-marketing` | ✅ default | `gh_form_submission_accepted` → `generate_lead` | sí (previsto) | ⏳ smoke de conversión pendiente | Publicado 2026-08-31; copy v3 revisado. Greenhouse-only; carga, validación vacía, prefill y regreso entre pasos verificados. Sin solicitud aceptada ni smoke GA4; no confirma entrega a HubSpot ni `generate_lead` observado. |
