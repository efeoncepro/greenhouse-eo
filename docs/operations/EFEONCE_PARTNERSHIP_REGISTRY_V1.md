...
> **Última revisión:** 2026-09-26 (Adobe, AWS y Microsoft declarados; Salesforce y Google Cloud confirmados por el operador); 2026-09-24 (BytePlus); 2026-09-21 (uso de la mascota Gigi / Google Gemini); 2026-09-19 (programmatic: Real Audiences y Basis); 2026-09-10 (plataformas publicitarias y retail media); resto 2026-08-28
...
| **Real Audiences** | DSP — managed por briefing o autogestionado con trader certificado | **Seleccionado por el CEO (2026-09-10); sin acuerdo firmado.** Contacto desde 2026-09-02 con Santiago Campos (Sales Director); desde 2026-09-16 lleva la relación Bautista Campos (Agency Partnerships Director), con Alex en copia. Declaró por escrito el 2026-09-19: inventario en CL, CO, MX, PE y EE.UU.; rebates o comisiones de agencia según inversión (sin %); sin mínimos; factura desde LLC en EE.UU.; CPM estimados display 0,20–0,25, video 0,33–0,38, push 0,15–0,20, audio 3–4 USD; pDOOH sin precio. No permite claim de partnership | Partner programático de Performance & Commerce: display, video, audio, pDOOH y push | Demo del Strategy Builder 2026-09-22 11:00 CL; pedir por escrito % y tramos del rebate, fees separados, CPM pDOOH por ciudad, lista de dominios/apps, verificación de terceros, cláusula de transparencia, CTV/ABM y entidad de facturación; Finance revisa tributación de la factura desde EE.UU.; owner: Julio + owner comercial de Performance | Hilos Outlook "Publicidad Omnicanal · Real Audiences DSP" (2026-09-02 a 09-07) y "Programmatic DOOH · Strategy Builder" (2026-09-16 a 09-19, con deck de formatos y presentación); [ficha](../services/media-distribution/PERFORMANCE_COMMERCE_DISTRIBUTION_SERVICE_V1.md#programmatic-vía-real-audiences) |
| **Basis** | Plataforma programática buy-side (DSP autogestionado para agencias, por confirmar) | **Contacto inicial (2026-09-17); reunión por agendar.** Manuel Ramos Bernard, VP LATAM (CDMX), pidió horarios; fuera del 22 al 24 de septiembre. Nada verificado sobre modelo, fees, inventario LATAM ni pDOOH | Segunda opción de DSP para Performance & Commerce, comparada con la misma lista que Real Audiences | Proponer horario desde el 25-09; llevar la lista de comparación de la ficha; owner: Julio | Correo "Efeonce / Basis - DSP", 2026-09-17; [ficha](../services/media-distribution/PERFORMANCE_COMMERCE_DISTRIBUTION_SERVICE_V1.md#basis--segunda-opción-en-evaluación) |
| **MiQ (ex Adsmovil LATAM)** | Trading desk / programmatic omnicanal | **No iniciado — alternativa** (2026-09-10) | Fallback si Real Audiences no cubre CTV, ABM o transparencia | Ninguno mientras Real Audiences avance | Market update 2026-09-10 |
| **TenX** | Partner de DV360 (managed) | **No iniciado — alternativa** (2026-09-10) | Fallback programático | Ninguno mientras Real Audiences avance | Market update 2026-09-10 |
...
| **Anthropic / Claude** | Claude Solution Partner | **Aceptado** (declaración del operador 2026-09-17); tier, términos y guías de marca pendientes de readback | Agentes, razonamiento, knowledge systems y managed agents; uso de marca y mascota Clawd en la narrativa «Tu IA no conoce tu negocio» | Archivar comunicación de aceptación, términos y guía de marca/mascota; documentar casos de producción; owner: Julio + práctica IA | Declaración del operador 2026-09-17; auditoría comercial 2026-07-26; mailbox |
| **OpenAI** | Solution/partner route | **Aceptado** (declaración del operador 2026-09-17); tier, términos y guías de marca pendientes de readback | Agentes, automatización e integraciones; uso de marca y Codex Pets en la narrativa «Tu IA no conoce tu negocio» | Archivar comunicación de aceptación, términos y guía de marca/mascotas; owner: Julio | Declaración del operador 2026-09-17; auditoría comercial 2026-07-26; mailbox |
| **BytePlus / ByteDance** | Partnership BytePlus + Order Form de consumo | **Partnership activo** (confirmación del operador, 2026-09-24). El Order Form recibido contiene una matriz de descuentos de **0% a 60%** para 43 configuraciones; el descuento máximo es Seedance 2.0 mini (**60%**). **Vigencia del tarifario por confirmar**: el PDF revisado no trae fecha efectiva ni firmas visibles/digitales; el propio formulario condiciona la efectividad a su ejecución, placement exitoso y proceso interno de BytePlus | Distribución y servicios para Seedance/Seedream; consumo de modelos y generación | Archivar la copia firmada por ambas partes y confirmar en BytePlus Account que las tarifas quedaron aplicadas. Registrar cualquier cambio de vigencia o descuento contra el anexo. Owner: Julio | Confirmación del operador (2026-09-24); [auditoría del Order Form y matriz de descuentos](../audits/commercial/BYTEPLUS_ORDER_FORM_AND_DISCOUNTS_2026-09-24.md); PDF `CT20260924149968.pdf` recibido el 2026-09-24 |
| **Adobe** | Programa de partners de Adobe (programa y nivel por confirmar) | **Partnership declarado por el operador (2026-09-26)**; programa, tier, términos y guía de uso de insignia pendientes de readback | Creative Operations y producción creativa (Creative Cloud, Firefly, Express) | Archivar la comunicación de aceptación, identificar el programa y el nivel y descargar la insignia oficial desde el portal de partners antes de usarla en firma, web o propuestas; owner: Julio + Creative Practice | Declaración del operador 2026-09-26 |
| **Truora** | Partnership comercial (WhatsApp, identidad y firma electrónica; incluye ZapSign) | **Partnership declarado por el operador (2026-09-26)**; existe un Partnership Agreement de 2024-09 y un NDA en OneDrive. Vigencia y condiciones actuales pendientes de readback | Onboarding digital, WhatsApp comercial y firma electrónica en proyectos de clientes | Revisar la vigencia del acuerdo de 2024; no se muestra en la firma de correo (decisión del operador, 2026-09-26); owner: Julio | OneDrive `Alineación/7. Branding & Diseño/04. Logos & Partnership/08. Truora/` (Partnership Agreement Efeonce 2024.09, NDA) + declaración del operador 2026-09-26 |
...
| **AWS** | AWS Partner Central | **Partnership declarado por el operador (2026-09-26)**; el corte 2026-07-26 lo tenía **bloqueado** por verificación de identidad: confirmar en Partner Central que quedó resuelta, el path/tier y la insignia oficial | Rail cloud para clientes AWS-first | Completar documento + selfie y luego onboarding empresarial; owner: Julio | Auditoría comercial 2026-07-26 |
| **Salesforce** | Consulting Partner; Cloud Reseller no confirmado | **Aceptación histórica como Provisional Consulting Partner (2025-03-11); el operador declara el partnership vigente (2026-09-26); tier, SPPA e insignia oficial pendientes de readback en Partner Community** | Carril Salesforce-first: CRM core, Agentforce, Marketing Cloud Engagement/Next y servicios enterprise/B2C | Recuperar Partner Community; verificar Partner Account, SPPA, tier, certificaciones, Demo/Dev/Trial y track Cloud Reseller antes de claim o reventa; owner: Julio + RevOps & CRM | Correo Salesforce 2025-03-11 registrado en LIC-6533 + declaración del operador 2026-08-27 |
...
| **Microsoft AI Cloud** | Partner ecosystem (Microsoft AI Cloud Partner Program; programa exacto por confirmar) | **Partnership declarado por el operador (2026-09-26)**; antes figuraba como target. Programa, designación, términos e insignia oficial pendientes de readback en Partner Center | Azure AI y clientes Microsoft-first | No abrir hasta existir oportunidad, owner y economics claros | Modelo Partner & Provider Layer V1 |
