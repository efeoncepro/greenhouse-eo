...
| **Real Audiences** | DSP — managed por briefing o autogestionado con trader certificado | **Seleccionado por el CEO (2026-09-10); sin acuerdo firmado.** Contacto comercial abierto desde 2026-09-02 con Santiago Campos (Sales Director); declara inventario en CL, CO, MX, PE y EE.UU. No permite claim de partnership | Partner programático de Performance & Commerce: display, video, audio, pDOOH y push | Reunión de presentación; pedir por escrito fees de plataforma, datos y servicio, mínimos, aceptación de la cláusula de transparencia, verificación de brand safety, reporte por placement, CTV y ABM B2B; agendar la certificación de un trader y su backup; owner: Julio + owner comercial de Performance | Hilo Outlook "Publicidad Omnicanal · Real Audiences DSP", 2026-09-02 a 09-07; [market update 2026-09-10](../audits/commercial/PERFORMANCE_MEDIA_CHANNELS_PARTNERS_PRICING_RESEARCH_2026-09-10.md) |
