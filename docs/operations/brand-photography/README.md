...
| 7 | [`EFEONCE_PHOTO_LEVERS_CATALOG_V1.md`](./EFEONCE_PHOTO_LEVERS_CATALOG_V1.md) | **Catálogo de palancas**: el índice de las **37 en cuatro familias** (5 siempre activas · 4 atmósferas · 1 acción suspendida · 27 de encuadre), qué campo pide cada una y cuántas admite una pieza; ficha completa de las 27 de encuadre; las 20 tomas de cámara nombradas; las seis descartadas con su razón medida | Claude |
