...
| Recraft v4.1 Vector — Producer | `b5631c86-707a-41d9-8ecc-ef61caa8200c` | 4 cr | `globe-recraft-v4-1-real-generation.png` |
...
La generación Recraft terminó `completed/retained`; la captura muestra el SVG real, modelo
Recraft v4.1, capacidad `Imagen · vectorizar`, 4 créditos y estado `Guardada`. El mismatch de
transporte del CDN quedó corregido en Globe `84d6a8e` con verificación de bytes SVG y CSP sandbox.
