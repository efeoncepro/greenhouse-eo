...
El flujo de promoción por **squash-merge** hace que `main` (commits squash de releases previos) **no sea ancestro de `develop`**. Eso produce 3 condiciones recurrentes que **NO son fallas reales** — reconocelas y aplica la mitigación en vez de perseguirlas:
