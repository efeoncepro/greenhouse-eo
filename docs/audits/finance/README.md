...
- [FINANCE_DEEP_OPERABILITY_AUDIT_2026-06-20](FINANCE_DEEP_OPERABILITY_AUDIT_2026-06-20.md) — auditoria profunda post-audit sobre ventas, compras, ingresos, egresos, OC, banco, caja, F29/F22, payment orders, reconciliacion, Cost Intelligence, syncs e integraciones. Decision `warning`: ledger/caja sanos, pero DTE retry queue sin tabla gobernada + runtime DDL, controles finos TASK-1192/1193/1194 pendientes, fiscal mensual parcialmente shadow, junio 2026 no canonico para margen y data-quality con checks legacy.
