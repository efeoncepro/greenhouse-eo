...
### Checkpoint de ejecución 2026-08-30 — candidato visual de Home

**Revisión posterior de seis comentarios:** títulos claros sobre azul, diez imágenes de la antigua Home,
HubSpot Simple Icons, marquesina compartida de Redes Sociales y agenda horizontal con enlace a `/agenda/`.
El formulario demo se retiró por instrucción del operador; el contrato anterior de formulario queda
supersedido para esta Home. Evidencia y límites: [audit visual](../../audits/public-site/2026-08-30-home-visual-review.md).
Segunda tanda aplicada y verificada: Ecosistema claro, agenda teal, FAQ sin solape responsive y logo HubSpot
en Respaldo oficial. Sólo evolución de widgets; hash Elementor y metadatos de portada intactos.
Tercera tanda: hover sostenido de CTA reparado, mail de FAQ retirado, cierre de comparación moderado,
CRM sprocket, halos suaves e isotipo proporcional. Hash nuevo `0e09940d…`; snapshot `184109`, evidencia en audit.

**Actualización posterior del mismo día:** el operador pidió hacer esta página la Home. Cutover aplicado:
`page_on_front=251731`, canonical raíz e indexación habilitada; Home anterior `2791` conservada noindex,
menú actualizado y metadatos SEO existentes preservados. Snapshot `_gh_home_cutover_20260830_162109`;
ver [contrato vigente](../../architecture/public-site/AGENCY_ELEMENTOR_MODULES_V1.md).
El cambio de portada está verificado a 1280/390; no cierra pendientes de copy/claims
ni editor save/reload. La narración siguiente es el checkpoint de preview anterior a la promoción.

Por instrucción del operador se implementó primero, con fidelidad al HTML exportado por Claude Design, una página de revisión en `https://efeoncepro.com/home-claude-design-preview/` (WordPress `251731`, `publish + noindex`). Usa header y footer Ohio globales; conserva las 16 regiones y microinteracciones del cuerpo; mantiene placeholders en los 12 slots cuyo estado multimedia no venía en el ZIP. La Home vigente `2791` no se modificó, el copy queda diferido y no hubo cambio de navegación, indexación ni cutover. Este checkpoint ejecuta el rework visual de Home ordenado por [PDR-010](../../public-site/decisions/PDR-010-home-es-el-pitch-agencia-se-pliega.md); no restituye `/agencia/` como URL canónica separada. La task permanece `to-do` y `UI ready: no` hasta afinar el diseño, trabajar copy/CRO/SEO y aprobar la promoción.

## Why This Task Exists

**Corrección técnica del checkpoint:** por instrucción explícita del operador, la preview ahora utiliza
17 widgets semánticos reales en contenedores nativos, cero widgets HTML, controles de contenido y siete
repeaters. El carril HTML descrito en el plan histórico inferior queda supersedido para esta ejecución.
Contrato as-built, evidencia, snapshots y pendientes en
[Agency Elementor Modules V1](../../architecture/public-site/AGENCY_ELEMENTOR_MODULES_V1.md).
El frontend está desplegado y verificado; la prueba desde la interfaz del editor espera login WordPress.
No se declara completa la task ni aprobado el copy/cutover.
