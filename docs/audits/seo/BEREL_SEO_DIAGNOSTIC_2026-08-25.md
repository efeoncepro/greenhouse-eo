...
- Fecha: 2026-08-25 · Versión: **1.2** (2026-08-25 — se agregan los enlaces a los dos documentos hermanos: el research del Color del Año 2027 y la arquitectura de autoridad del blog. El cuerpo del diagnóstico no cambió; el segundo hermano **declara una discrepancia de conteo** con §2 y §3.4 de este documento y no la resuelve)
...
- Documento hermano: [**Arquitectura de autoridad del blog y plan editorial de octubre**](BEREL_ARQUITECTURA_AUTORIDAD_2026-08-25.md) — mide el **grafo de enlaces internos** con el filtro de chrome aplicado (**0,38 enlaces editoriales por artículo, 86% sin entrante, 16–23% a soft 404**), documenta que **la entidad "Color del Año Berel" está huérfana**, el hueco de vocabulario del corpus, el estado real de los slots de octubre y los tres briefs entregados. ⚠️ **Declara dos discrepancias de conteo con este diagnóstico y no las resuelve**: **113 vs. 115 artículos** y **43 vs. 112 enlaces editoriales**. Reconciliar antes de citar cualquiera de las dos cifras al cliente.
