# Brief operativo — carril HubSpot de «Tu IA no conoce tu negocio»

> Estado: brief documental · no es calendario ni autorización para publicar o pautar · 2026-09-22.
> Criterio y límites: [CDR-004](../../../campaigns/decisions/CDR-004-tu-ia-no-conoce-carril-hubspot.md).
> Canon de tesis: [narrativa Q4–Q3](../../../strategy/EFEONCE_AI_CONTEXT_NARRATIVE_2026Q4_2027Q3_V1.md).
...
el sujeto; HubSpot es el cómo**.

## 1. Qué se puede producir hoy

Tres gates independientes deciden la habilitación de cada pieza. No se negocian entre sí: un `no` en cualquiera
detiene esa columna, no el carril completo.
...
Cada ficha es una unidad de producción. Una pieza resuelve **un dolor para un comprador**; no se fusionan.

### 2.1 · «No sé cuánto pipeline tengo» — CRO

| | |
|---|---|
| **Capítulo** | 1 · Lo que tu IA no sabe |
| **Familia** | Sales & AI Pipeline, sobre Smart CRM |
| **Movimiento de pregunta** | El CRM ya captura llamadas, correos y reuniones solo. Capturar la conversación no es registrar por qué cambió la decisión, ni quién autoriza la siguiente acción. |
...
| | |
|---|---|
| **Capítulo** | 2 · Lo que tu IA cree que es cierto |
| **Familia** | Data, Integration & CRM Intelligence |
| **Movimiento de pregunta** | Dos equipos, dos denominadores, una sola verdad declarada. El desacuerdo no es de criterio: es de definición. |
...
|---|---|
| **Capítulo** | 2 · Lo que tu IA cree que es cierto |
| **Familia** | Data, Integration & CRM Intelligence (Data Hub) |
| **Movimiento de pregunta** | El CRM puede corregirse solo. La pregunta dejó de ser quién digita y pasó a ser qué fuente gana, quién revisa lo que entendió y quién puede revertirlo. |
...
| | |
|---|---|
| **Capítulo** | 3 · Lo que la IA dice de ti |
| **Familia** | Marketing, Content & AEO |
| **Movimiento de pregunta** | Antes de hablar con tu equipo, ya te evaluó una IA. Y respondió con la información pública que encontró, no con la que le habrías dado. |
| **Objeto de la pieza** | Muestra fechada de respuestas por motor y pregunta, con exactitud y fuente. Radiografía AEO es el activo existente. |
| **Prueba** | Radiografía AEO — activo propio vigente |
| **Registro** | **Neutral.** Este dolor no requiere HubSpot; forzarlo lo debilita. Provider-specific solo si el cliente ya opera Content Hub |
| **Destino** | Radiografía AEO; hub solo si el fit es HubSpot |
| **Prohibido** | Prometer ranking; ChatGPT Ads como disponible en Chile (beta pública, mercados habilitados) |

### 2.5 · «Mi postventa es invisible» — COO / CS

| | |
|---|---|
| **Capítulo** | 4 · Un equipo, no una herramienta |
| **Familia** | Service, Customer Success & Delivery |
| **Movimiento de pregunta** | Un agente puede responder. La pregunta es qué no debe resolver solo, y quién lo recibe cuando se detiene. |
| **Objeto de la pieza** | Ficha de rol `read / propose / write`, el disparador de handoff y una excepción con su corrección. |
...
|---|---|
| **Capítulo** | 4 · Un equipo, no una herramienta |
| **Familia** | Agent Hub & Agentic Operations |
| **Movimiento de pregunta** | HubSpot nombra tres capas y la tercera —decidir qué hacen los agentes solos y qué queda con personas— la nombra y no la llena. Comprar agentes no es armar un equipo. |
...
| | |
|---|---|
| **Capítulo** | **ninguno** — hueco declarado en CDR-004 §10 |
| **Familia** | Revenue Lifecycle |
| **Estado** | **No se produce hasta decidir** si entra por la capa «Resultados, no output» o queda fuera de la narrativa y se vende solo por hub. No se le fabrica un capítulo por simetría. |

## 3. La pieza de autoridad que no necesita landing

Independiente de las siete fichas, el ángulo más fuerte del carril según la regla del vacío es **cuándo NO conviene
HubSpot para un caso concreto**: HubSpot jamás lo escribirá y el vacío sigue vacío. No requiere destino nuevo —su
...
No son olas con fecha: son tramos ordenados por prueba disponible y bloqueo.

| Tramo | Contenido | Por qué primero | Bloqueo |
|---|---|---|---|
| **1** | Fichas 2.5 y 2.6 (capítulo 4) + el ángulo «cuándo no» | Única prueba publicada del carril; el vacío más fuerte | Ninguno para orgánico |
| **2** | Fichas 2.1, 2.2 y 2.3 (capítulos 1 y 2) | Cierra el hueco del core RevOps; método propio sin depender de caso | Sin caso publicable: se publica método con límite |
...
Por **dolor y familia**, nunca por capítulo agregado: un capítulo alimenta ofertas distintas y el promedio oculta
cuál funcionó. Métrica primaria: conversaciones calificadas que llegan a evaluación inicial sin costo o a un modo de
entrega pagado. Métricas de avance por familia: blueprints y auditorías vendidas, implementaciones, sprints y
operación recurrente contratada.

Guardrails: calidad del lead, no-fit declarado, errores de claim de producto y capacidad de delivery. Engagement no
se suma como pipeline. La propiedad de campaña por capítulo en HubSpot requiere autorización y no existe todavía.

## 6. Dependencias antes de ejecutar
...
6. **Confirmar el readback del key visual paraguas** del 2026-09-21 antes de encadenar piezas que lo asuman publicado.
