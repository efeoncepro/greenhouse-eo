...
- [PDR-015 — Content Engineering como territorio editorial y doctrina de experiencia](decisions/PDR-015-content-engineering-territorio-editorial.md)
- [PDR-016 — Pillar + Cluster Experience federada: arquitectura editorial, social search, conversión y runtime](decisions/PDR-016-pillar-experience-arquitectura-editorial-y-runtime.md)
