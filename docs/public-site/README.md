...
- **[Web agéntica Pillar Gutenberg Spec V4](WEB_AGENTICA_PILLAR_GUTENBERG_SPEC_V4.json)** — corte privado vigente del post `249387`: 95 bloques semánticos, 14 H2 + 6 H3, tres infografías art-directed, supuestos WebMCP/Chrome y mercado revalidados, evals por capas y cadena de autoridad. No autoriza publicación.
