...
> **Placement editorial:** [PDR-016](PDR-016-pillar-experience-arquitectura-editorial-y-runtime.md) aclara que
...
Think (producto editorial)  Guía pillar "Visibilidad en búsqueda + IA"
                            (canonical host según PDR-016; linkea ↓ a spokes + grader)
...
- **Pillar de autoridad = guía del producto editorial Think** ("Visibilidad en búsqueda
  ...
  contenido (coherente con PDR-003), con host/canonical por resolver según PDR-016. Ahí "visibilidad" (genérico-amplio) es
...
- Contextual: cada spoke enlaza su hermana + el nodo grader + la guía pillar editorial (canonical según PDR-016).
...
- **SIEMPRE** el pillar de autoridad pertenece editorialmente al producto Think, no a
  la página de servicio genérica; esto no prescribe el subdominio y su host/canonical se decide por PDR-016.
