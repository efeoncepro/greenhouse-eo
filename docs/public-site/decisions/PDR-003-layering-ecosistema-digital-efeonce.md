...
> **Placement de Pillars:** [PDR-016](PDR-016-pillar-experience-arquitectura-editorial-y-runtime.md)
...
- **Think como producto no equivale al host `think.efeoncepro.com`.** Think nombra
  ...
  pertenecer a Think y conservar canonical en `efeoncepro.com`; PDR-016 gobierna
  el placement.
...
- Pillar Experience y placement: [PDR-016](PDR-016-pillar-experience-arquitectura-editorial-y-runtime.md).
