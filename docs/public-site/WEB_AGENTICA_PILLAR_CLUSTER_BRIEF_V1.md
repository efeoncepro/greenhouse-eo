...
- **Pillar:** `El fin de la web “solo para humanos”: cómo preparar tu sitio para los agentes de IA` — post WordPress `249387`.
- **Slug:** `web-agentica-agentes-ia`.
- **URL canónica vigente:** `https://efeoncepro.com/aeo/web-agentica-agentes-ia/`.
...
- Media WordPress: portada/OG `251553–251554`; 28 variantes SVG v7 `251514–251541`, integradas como siete
...
- V5 escrita y validada por Content Factory; publicada en
  `https://efeoncepro.com/aeo/web-agentica-agentes-ia/`.
- Estado WordPress: `publish`; autor humano `1`; categoría AEO `156`.
- Featured `251553`, OG/Twitter `251554` y siete infografías de cuerpo integradas. El delivery v7 pasó seguridad,
  geometría de archivo y QA live desktop/mobile, light/dark, `currentSrc` y overflow.
- Enlaces bidireccionales verificados: artículo → `/desarrollo-sitios-web/` `3`; landing → artículo `1`.
- `gh_cta_clicked` no fue instrumentado ad hoc; la medición sigue pendiente de contrato runtime gobernado.
- Cierre y reversibilidad: `docs/audits/public-site/2026-07-18-web-agentica-pillar-publication.md`.
