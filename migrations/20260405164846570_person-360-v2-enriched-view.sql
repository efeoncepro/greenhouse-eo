-- Up Migration
-- person_360 v2 — enriched serving view with resolved fields, full member/user/CRM facets
-- Replaces the rollup-based VIEW with one that uses LATERAL joins for deterministic first-record
-- and exposes resolved_avatar_url, resolved_job_title, resolved_phone, etc.
...
-- Down Migration
-- Restore the previous person_360 VIEW (rollup-based, without resolved_avatar_url etc.)
-- This is intentionally left as a placeholder — the old VIEW can be found in
-- migration 20260402094316652_task-193-operating-entity-session-canonical-person.sql
