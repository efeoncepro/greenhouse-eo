...
// TASK-950 — List page error boundary canonical (TASK-946 framework #6 retriable).
//
...
// aquí indica un fallo no anticipado (e.g. render crash, edge case loader).
...
const ErrorBoundary = ({ error, reset }: ErrorBoundaryProps) => {
  useEffect(() => {
    ...
    console.error('[NexaInsightList] render error:', error)
  }, [error])
