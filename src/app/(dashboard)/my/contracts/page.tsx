...
export const metadata: Metadata = { title: 'Mis contratos | Greenhouse' }
...
const Page = async () => {
  ...
  const items = tenant.identityProfileId
    ? await getOwnContractingSummary(tenant.identityProfileId, 'employment_contract')
    : []

  return <MyContractingDocumentsView kind='employment_contract' items={items} />
}
