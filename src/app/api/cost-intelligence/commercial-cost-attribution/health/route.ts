...
import { getCommercialCostAttributionHealthSummary } from '@/lib/commercial-cost-attribution/insights'
...
export async function GET(request: Request) {
  ...
  const summary = await getCommercialCostAttributionHealthSummary(year, month)
