...
import { cancelContractorPayable } from '@/lib/contractor-engagements/payables/store'
...
export async function POST(request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const payable = await cancelContractorPayable({
    ...
    captureWithDomain(error, 'finance', { tags: { source: 'contractor_payables_cancel_api' } })
