...
export async function POST(request: Request) {
  ...
  if (!can(tenant, 'finance.bank_accounts.create', 'create', 'tenant')) {
    return NextResponse.json({ error: 'No tienes permiso para crear cuentas bancarias.', code: 'forbidden' }, { status: 403 })
  }
