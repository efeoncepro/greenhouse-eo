...
describe('GET /api/commercial/organizations/[id]/deals', () => {
  ...
  it('returns cached local deals by default without blocking on HubSpot hydration', async () => {
    ...
    expect(mockListCommercialDealsForOrganization).toHaveBeenCalledTimes(1)
  ...
  it('re-reads the canonical store after an explicit live HubSpot refresh', async () => {
