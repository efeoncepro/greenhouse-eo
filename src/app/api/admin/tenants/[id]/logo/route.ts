...
import { setTenantLogoAssetPath } from '@/lib/admin/media-assets'
import {
...
export async function POST(request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    return NextResponse.json({ error: 'No pudimos guardar el logo del space.' }, { status: 500 })
  }
}
