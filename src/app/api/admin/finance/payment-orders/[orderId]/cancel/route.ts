...
export async function POST(
  ...
  if (!can(tenant, 'finance.payment_orders.cancel', 'update', 'tenant')) {
    return NextResponse.json({ error: 'No tienes permiso para cancelar órdenes de pago.', code: 'forbidden' }, { status: 403 })
  }
