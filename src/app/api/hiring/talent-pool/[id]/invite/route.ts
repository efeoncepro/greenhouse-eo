...
import { hiringInvalidBodyResponse, inviteTalentToOpening, talentPoolFlags, toHiringErrorResponse } from '@/lib/hiring'
...
export async function POST(request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    return toHiringErrorResponse(error, 'talent_pool_invite')
  }
}
