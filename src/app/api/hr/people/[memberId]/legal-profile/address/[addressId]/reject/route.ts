...
import { PersonLegalProfileError, rejectPersonAddress } from '@/lib/person-legal-profile'
...
export async function POST(request: Request, { params }: RouteParams) {
  ...
  try {
    const result = await rejectPersonAddress({
      addressId,
    ...
    captureWithDomain(error, 'identity', { extra: { route: 'hr/legal-profile/address/reject', addressId } })
