...
import { voidFinalSettlementDocumentForCase } from '@/lib/payroll/final-settlement'
...
export async function POST(request: Request, context: { params: Promise<{ caseId: string }> }) {
  ...
  try {
    ...
    const document = await voidFinalSettlementDocumentForCase({
    ...
    return toResponse(error, 'Unable to void final settlement document.')
  }
}
