    ...
    build: () =>
      base({
        ...
        content: {
          ...
          body: 'Elige la fecha y hora que mejor te acomoden.',
          ctaLabel: 'Ver horarios',
          dismissLabel: 'Ahora no',
          footnote: 'Disponibilidad en tu zona horaria.',
        },
      }),
  },
    ...
    build: () =>
      base({
        ...
        content: {
          eyebrow: '30 min · Microsoft Teams',
          headline: 'Conversemos sobre tu próximo desafío',
          body: 'Elige la fecha y hora que mejor te acomoden sin salir de esta página.',
          ctaLabel: 'Ver horarios',
          dismissLabel: 'Ahora no',
        },
      }),
