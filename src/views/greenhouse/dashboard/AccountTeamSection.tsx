  ...
  return (
    <Box sx={{ display: 'grid', gap: 3, gridTemplateColumns: { xs: '1fr', xl: '1.2fr 1fr' } }}>
      <ExecutiveCardShell
        ...
        subtitle='Lectura ejecutiva de staffing visible mezclando señal real y overrides controlados.'
      >
        <Stack spacing={2}>
      ...
      <ExecutiveCardShell
        ...
        subtitle='Capa reusable inicial para clientes con staff asignado por cuenta o por modulo.'
      >
        <MetricList
          items={[
            {
