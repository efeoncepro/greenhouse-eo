...
const checklist = [
  {
    ...
    detail: 'Revisar borradores o submissions pendientes antes de cerrar.',
    status: '1 pendiente',
    tone: 'warning' as const
  },
  {
    id: 'post-close',
    title: 'Invoice post-cierre',
  ...
  {
    id: 'access',
    title: 'Acceso y handoff',
    detail: 'El retiro de accesos vive en offboarding/identity, separado del cierre contractual.',
    status: 'Separado',
    tone: 'secondary' as const
  }
]

const ContractorClosureSidecarMockup = ({ scenario }: { scenario: ContractorScenario }) => (
  <OperationalPanel
    title='Cierre contractor'
    subheader='Checklist visual para cerrar el engagement sin usar finiquito laboral.'
...
export default ContractorClosureSidecarMockup
