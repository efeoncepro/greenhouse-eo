...
import type { ContractorTimelineStep } from '@/lib/contractor-engagements/projection-types'
            ...
            <Stack alignItems='center' sx={{ pt: 0.5 }}>
              <Box
                sx={{
                  ...
                  color: meta.color,
                  bgcolor: alpha(
                    meta.bgcolor === 'text.disabled'
                      ? theme.palette.text.disabled
                      : theme.palette[meta.bgcolor.split('.')[0] as 'success' | 'primary' | 'error'].main,
                    0.12
                  )
                }}
