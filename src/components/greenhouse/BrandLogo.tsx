...
const brandRegistry: Record<string, BrandRegistryEntry> = {
  ...
  linkedin: { iconClassName: 'fi-brands-linkedin', fallbackIconClassName: 'tabler-brand-linkedin' },
  behance: { iconClassName: 'fi-brands-behance', fallbackIconClassName: 'tabler-brand-behance' },
  dribbble: { iconClassName: 'fi-brands-dribbble', fallbackIconClassName: 'tabler-brand-dribbble' },
  github: { iconClassName: 'logos-github-icon', fallbackIconClassName: 'tabler-brand-github' },
  twitter: { iconClassName: 'fi-brands-twitter-alt', fallbackIconClassName: 'tabler-brand-twitter' },
  x: { fallbackIconClassName: 'tabler-brand-x' },
  threads: { fallbackIconClassName: 'tabler-brand-threads' },
