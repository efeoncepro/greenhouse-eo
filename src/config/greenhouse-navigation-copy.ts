...
const enUS: NavigationCopy = {
  ...
  internal: {
    ...
    zoneOperacion: { label: 'Operations', subtitle: 'Day-to-day operational domains' },
    zoneAdministracion: { label: 'Administration', subtitle: 'Platform configuration and governance' },
    zoneRecursos: { label: 'Resources', subtitle: 'Cross-cutting utilities' },
    domainAgencia: { label: 'Agency', subtitle: 'Agency operations' },
    domainPersonas: { label: 'People', subtitle: 'Directory, payroll and HR' },
    domainFinanzas: { label: 'Finance', subtitle: 'Flow, treasury and intelligence' },
    sectionAgenciaResumen: { label: 'Overview', subtitle: 'Agency, Spaces and economics' },
    sectionNomina: { label: 'Payroll', subtitle: 'Settlement and projection' },
    sectionSupervision: { label: 'Supervision', subtitle: 'Team, approvals and departments' },
    sectionOrganizacion: { label: 'Organization', subtitle: 'Hierarchy, leave and attendance' },
    sectionDesarrollo: { label: 'Development', subtitle: 'Goals and evaluations' },
    adminPlatform: { label: 'Platform', subtitle: 'Infrastructure and observability' },
    adminTenantsDisambiguated: { label: 'Spaces (admin)', subtitle: 'Spaces, access and portal governance' },
    ...
    adminDesignCatalog: { label: 'AXIS catalog', subtitle: 'Tokens, primitives, patterns and internal labs' },
    adminDesignHandoff: { label: 'Design handoff', subtitle: 'Product designs queued for implementation' },
  ...
  hr: {
    ...
    workforceContracts: { label: 'Employment contracts', subtitle: 'Bilingual offer letters and contracts' },
