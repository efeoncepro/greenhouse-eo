...
export const GH_INTERNAL_NAV = {
  ...
  adminDesignCatalog: { label: 'Catálogo AXIS', subtitle: 'Tokens, primitives, patrones y labs internos' },
  adminDesignHandoff: { label: 'Design handoff', subtitle: 'Registro de diseños de producto por implementar' },
...
// Compatibility re-export only. Nexa UI copy lives in `src/lib/copy/nexa.ts`
// per TASK-811; new code should import from `@/lib/copy/nexa` directly.
export { GH_NEXA } from '@/lib/copy/nexa'
