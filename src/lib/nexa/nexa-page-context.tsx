 ...
 */
export const NexaContextScope = ({ entityName, contextKey, entityId, entityKind, entrypoint }: NexaPageContextValue) => {
  const setContext = useContext(NexaSetContext)

  useEffect(() => {
    setContext({ entityName, contextKey, entityId, entityKind, entrypoint })
