...
export const GH_WORKFORCE_ACTIVATION = {
  ...
  filter_external_identity: 'Sin Notion',
  ...
  member_search_label: 'Buscar persona',
  member_search_placeholder: 'Nombre o correo',
  member_search_action: 'Buscar',
  member_search_helper: 'Incluye fichas completadas para resolver identidad externa post-activación.',
  ...
  resolver_external_identity_section: 'Identidad externa',
  resolver_external_identity_open: 'Resolver Notion',
  external_identity_title: 'Resolver identidad Notion',
  external_identity_subtitle: (displayName: string) => `Busca y aprueba el usuario Notion de ${displayName}.`,
  external_identity_missing: 'Sin candidatos disponibles',
  external_identity_unavailable: 'Notion no está disponible para discovery.',
  external_identity_conflict: 'Link en conflicto',
  external_identity_candidate: 'Candidato',
  external_identity_approve: 'Aprobar link',
  external_identity_reject: 'Rechazar candidato',
  external_identity_loading: 'Buscando usuarios Notion…',
  external_identity_saved: 'Identidad Notion resuelta',
  external_identity_error: 'No fue posible resolver la identidad Notion.',
  ...
  resolver_role_title: 'Cargo vigente',
  resolver_role_title_helper: 'Se guarda en la primitiva canónica de cargo laboral y queda auditado.',
  resolver_role_title_reason_required: 'Indica un motivo de al menos 10 caracteres para cambiar el cargo.',
