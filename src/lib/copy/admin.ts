...
export const GH_INTERNAL_MESSAGES = {
  ...
  admin_tenant_settings_locale_title: 'Idioma del space',
  admin_tenant_settings_locale_description:
    'Default usado cuando un usuario no tiene idioma personal configurado.',
  admin_tenant_settings_locale_label: 'Idioma default',
  admin_tenant_settings_locale_loading: 'Cargando idioma...',
  admin_tenant_settings_locale_saving: 'Guardando idioma...',
  admin_tenant_settings_locale_saved: 'Idioma guardado.',
  admin_tenant_settings_locale_error: 'No pudimos guardar el idioma del space.',
