...
export const careers: CareersCopy = {
  ...
  manifesto: {
    ...
    titleMark: 'marketing',
    titleSuffix: '.',
    chips: ['With method', 'With data', 'Measurable creativity'],
    proofMuted: 'We do not leave it as intent.',
    proofStrong: 'We operate it.',
  ...
  pillars: {
    ...
    title: 'You bring judgment and drive. We bring the system.',
    subtitle: 'We look for curious, rigorous people who want to build. This is what they find when they join.',
    items: [
      {
        title: 'Real growth',
  ...
  listing: {
    ...
    title: 'Open roles',
    subtitle: 'Real roles, a clear process, and room to grow. Find yours and apply in minutes.',
    ...
    errorBody: 'Something went wrong while loading openings. Retry from this page in a moment.',
    retry: 'Retry',
  ...
  talentPool: {
    eyebrow: 'Talent pool',
    title: 'Your role does not exist yet? Let us meet you.',
    body: 'If you want to change how marketing is done with method, data, and judgment, we want to meet you even if your role is not open today.',
  ...
  detail: {
    ...
    skillsHint: 'We evaluate these during the process, with a focus on evidence and real skills.',
  ...
  apply: {
    ...
    intro:
      'A short form: tell us who you are. We see talent in the process, not in paperwork; you can skip optional fields.',
    optionalWord: '(optional)',
    alertTitle: 'Protected application',
    ...
    invalidSummaryBody: 'Fix the marked fields to send your application.',
    ...
    placeholders: {
      email: 'you@email.com',
      residenceCountry: 'Select your country',
    ...
    cv: {
      ...
      body: 'Drag or select your CV as a PDF. We store it as a private file in Greenhouse.',
    ...
    errors: {
      ...
      invalid: 'Review the marked data and try again.',
