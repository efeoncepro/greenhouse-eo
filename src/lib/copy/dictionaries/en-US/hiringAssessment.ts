...
export const hiringAssessment: HiringAssessmentCopy = {
  taking: {
    ...
    submitGraceNotice: 'Time to answer is over. Answers can no longer be edited.',
    graceBodyComplete: 'All of your answers were saved: you can still submit the assessment.',
    graceBodyIncomplete: 'Some answers were not saved, so the assessment cannot be submitted. Reach out to whoever sent it to you to pick it up again.',
