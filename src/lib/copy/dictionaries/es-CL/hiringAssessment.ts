...
export const hiringAssessment: HiringAssessmentCopy = {
  taking: {
    ...
    submitGraceNotice: 'El tiempo para responder terminó. Las respuestas ya no se pueden editar.',
    graceBodyComplete: 'Todas tus respuestas quedaron guardadas: todavía puedes enviar la evaluación.',
    graceBodyIncomplete: 'Quedaron respuestas sin guardar, así que la evaluación no se puede enviar. Escríbele a quien te la envió para retomarla.',
