...
export const GH_PRICING_GOVERNANCE = {
  ...
  excel: {
    ...
    importPageSubtitle:
      'Sube un archivo Excel con el formato de export. Mostramos el diff contra el estado actual antes de aplicar cualquier cambio.',
    dropzoneLabel: 'Arrastra el archivo Excel o haz clic para seleccionar',
    dropzoneInvalidType: 'Solo se aceptan archivos .xlsx',
    uploadingLabel: 'Procesando archivo…',
    parseErrorLabel: 'No pudimos leer el archivo. Revisa que tenga el formato correcto.',
