...
export const GH_CLIENT_ONBOARDING = {
  ...
  space: {
    ...
    teamsSearchLabel: 'Equipo de Teams',
    teamsSearchPlaceholder: 'Busca el equipo del cliente en Microsoft Teams',
    teamsSearchHelper: 'Si el equipo ya existe, búscalo y ancla su canal. Si no, déjalo vacío y lo creamos.',
    teamsSearchEmpty: 'Sin resultados. Prueba con otro nombre o créalo nuevo.',
    teamsSearchDegraded: 'No pudimos buscar en Teams ahora. Puedes crear el canal nuevo.',
    ...
    provisionTeamsAnchoredLabel: 'Equipo anclado — no se crea un canal nuevo',
