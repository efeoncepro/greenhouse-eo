 ...
 * como dato, la versión cambia a `aeo-author.seo-grounded.v1` y los refs `seo.discovery.*` se
...
describe('TASK-1666 — authoring grounded', () => {
  ...
  it('el cerebro grounded es una versión SEPARADA que extiende el base sin modificarlo', () => {
    ...
    expect(AUTHOR_SEO_GROUNDED_SYSTEM_PROMPT_VERSION).toBe('aeo-author.seo-grounded.v1')
