...
const validDraft: ContentFactoryGeneratedDraft = {
  ...
  draft: {
    ...
    postContent: [
      ...
      '<!-- wp:list -->',
      '<ul>',
      '<li>Definir el objetivo comercial antes de generar contenido.</li>',
      '<li>Validar fuentes, tono y CTA antes de cualquier borrador WordPress.</li>',
      '</ul>',
      '<!-- /wp:list -->',
      ...
      '<!-- /wp:yoast-seo/table-of-contents -->',
      '<!-- wp:heading {"level":2} -->',
      '<h2>Como se gobierna el ciclo</h2>',
      '<!-- /wp:heading -->',
      '<!-- wp:paragraph -->',
      '<p>Este borrador se mantiene como artifact local hasta que exista aprobacion de smoke.</p>',
      '<!-- /wp:paragraph -->',
      '<!-- wp:quote -->',
      '<blockquote class="wp-block-quote"><p>Un draft seguro separa generacion, revision y publicacion.</p></blockquote>',
      '<!-- /wp:quote -->',
      '<!-- wp:heading {"level":3} -->',
      '<h3>Revision antes de escribir</h3>',
      '<!-- /wp:heading -->',
      '<!-- wp:paragraph -->',
