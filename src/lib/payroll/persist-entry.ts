...
const PAYROLL_ENTRY_MUTATION_TYPES = {
  ...
  chileAfpCotizacionAmount: 'FLOAT64',
  chileAfpComisionAmount: 'FLOAT64',
  chileGratificacionLegalAmount: 'FLOAT64',
  chileColacionAmount: 'FLOAT64',
  chileMovilizacionAmount: 'FLOAT64',
  chileHealthSystem: 'STRING',
  chileHealthAmount: 'FLOAT64',
  chileHealthObligatoriaAmount: 'FLOAT64',
  chileHealthVoluntariaAmount: 'FLOAT64',
  chileEmployerSisAmount: 'FLOAT64',
  chileEmployerCesantiaAmount: 'FLOAT64',
  chileEmployerMutualAmount: 'FLOAT64',
  chileEmployerTotalCost: 'FLOAT64',
  ...
  adjustedColacionAmount: 'FLOAT64',
  adjustedMovilizacionAmount: 'FLOAT64',
    ...
    `
      ...
      USING (
        SELECT
          ...
          @colacionAmount AS colacion_amount,
          @movilizacionAmount AS movilizacion_amount,
          ...
          @chileAfpCotizacionAmount AS chile_afp_cotizacion_amount,
          @chileAfpComisionAmount AS chile_afp_comision_amount,
          @chileGratificacionLegalAmount AS chile_gratificacion_legal,
          @chileColacionAmount AS chile_colacion_amount,
          @chileMovilizacionAmount AS chile_movilizacion_amount,
          @chileHealthSystem AS chile_health_system,
          @chileHealthAmount AS chile_health_amount,
          @chileHealthObligatoriaAmount AS chile_health_obligatoria_amount,
          @chileHealthVoluntariaAmount AS chile_health_voluntaria_amount,
          @chileEmployerSisAmount AS chile_employer_sis_amount,
          @chileEmployerCesantiaAmount AS chile_employer_cesantia_amount,
          @chileEmployerMutualAmount AS chile_employer_mutual_amount,
          @chileEmployerTotalCost AS chile_employer_total_cost,
          ...
          @adjustedColacionAmount AS adjusted_colacion_amount,
          @adjustedMovilizacionAmount AS adjusted_movilizacion_amount,
      ...
      WHEN MATCHED THEN
        UPDATE SET
          ...
          colacion_amount = source.colacion_amount,
          movilizacion_amount = source.movilizacion_amount,
          ...
          chile_afp_cotizacion_amount = source.chile_afp_cotizacion_amount,
          chile_afp_comision_amount = source.chile_afp_comision_amount,
          chile_gratificacion_legal = source.chile_gratificacion_legal,
          chile_colacion_amount = source.chile_colacion_amount,
          chile_movilizacion_amount = source.chile_movilizacion_amount,
          chile_health_system = source.chile_health_system,
          chile_health_amount = source.chile_health_amount,
          chile_health_obligatoria_amount = source.chile_health_obligatoria_amount,
          chile_health_voluntaria_amount = source.chile_health_voluntaria_amount,
          chile_employer_sis_amount = source.chile_employer_sis_amount,
          chile_employer_cesantia_amount = source.chile_employer_cesantia_amount,
          chile_employer_mutual_amount = source.chile_employer_mutual_amount,
          chile_employer_total_cost = source.chile_employer_total_cost,
          ...
          adjusted_colacion_amount = source.adjusted_colacion_amount,
          adjusted_movilizacion_amount = source.adjusted_movilizacion_amount,
      ...
      WHEN NOT MATCHED THEN
        INSERT (
          ...
          chile_afp_rate,
          chile_afp_amount,
          chile_afp_cotizacion_amount,
          chile_afp_comision_amount,
          chile_gratificacion_legal,
          chile_colacion_amount,
          chile_movilizacion_amount,
          chile_health_system,
          chile_health_amount,
          chile_health_obligatoria_amount,
          chile_health_voluntaria_amount,
          ...
          adjusted_colacion_amount,
          adjusted_movilizacion_amount,
          manual_override,
        ...
        VALUES (
          ...
          source.colacion_amount,
          source.movilizacion_amount,
          ...
          source.chile_afp_cotizacion_amount,
          source.chile_afp_comision_amount,
          source.chile_gratificacion_legal,
          source.chile_colacion_amount,
          source.chile_movilizacion_amount,
          source.chile_health_system,
          source.chile_health_amount,
          source.chile_health_obligatoria_amount,
          source.chile_health_voluntaria_amount,
          source.chile_employer_sis_amount,
          source.chile_employer_cesantia_amount,
          source.chile_employer_mutual_amount,
          source.chile_employer_total_cost,
          ...
          source.adjusted_colacion_amount,
          source.adjusted_movilizacion_amount,
