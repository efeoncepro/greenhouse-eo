...
| Precio | ✅ **MXN 52.000/mes** — **lista 60.000 − 13,3% de descuento** *(operador, 2026-08-15)*. 🔴 **Alcance Crecimiento COMPLETO al 87% del precio de lista** | ✅ **CLP 3.000.000 netos/mes + IVA** · 24 meses · **TCV CLP 72.000.000 neto**. ~~5.200.000/mes plan base~~ *(oferta original, superseded)* |
