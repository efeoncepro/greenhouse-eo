...
- 🔴 **`keyword_difficulty` NO deriva la barrera de enlaces** (colapsa a 0 en SERPs es-LATAM). Canónico: `deriveLinkBarrier()` sobre `avg_backlinks_info`, ponderando diversidad de dominios referentes + page rank, nunca el conteo de enlaces. Ver `references/02-labs.md` §7 gotcha 8.
