...
| Agenda pilot | `https://efeoncepro.com/agenda/` | `251583` | publish + noindex | `landings/agenda.md` | TASK-1510 isolated native scheduler pilot; normal Ohio template, Elementor HTML host only, surface `fhsf-efeonce-lead-gen-web` / `discovery`, HubSpot direct-link fallback; do not promote to Contacto/RRSS before controlled booking + GTM evidence |
