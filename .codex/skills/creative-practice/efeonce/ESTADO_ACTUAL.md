...
|---|---|
| 🎯 **SKY — Agencia Creativa** | ✅ **CLIENTE CREATIVO VIGENTE.** Service modules **`agencia_creativa` + `globe`**. Squad: **Daniela Ferreira** *(Creative Ops Lead / dir. de arte)* + **Melkin Hernández** y **Andrés Carlosama** *(Senior Visual Designers)*. Atiende al **equipo de Performance** de SKY. Proyecto iniciado **ago-2025**; primer año cumplido y **contrato renovado por un año más**. SKY es la cuenta principal del squad, que también atiende otras cuentas *(p. ej. Grupo Berel)* con dedicación mucho menor. 🎯 **Y la telemetría EXISTE** *(§1: RpA medido, muy bajo el umbral)*. Además ya existe el primer **Efeonce Wrapper** anual para cliente (`https://experiencia.efeoncepro.com`), creado para SKY por su primer año. **Actualización 2026-09-23: el caso creativo está PUBLICADO en ese wrapper**, con métricas de 12 meses de **entrega/operación**: +2.000 piezas aprobadas · 39 campañas *(CyberSKY, Travel Sale, Sky Sale, Black Sky…)* · 88% on-time · 0,12 ajustes promedio por pieza · 5 mercados conectados · 25% menos tiempo de producción. 🔴 Son métricas de delivery, **no de negocio del cliente**; **no hay baseline del día 0**; la **autorización escrita para citarlo fuera del wrapper no está verificada**. **Caso autorizado para nombrar como caso de éxito**, con claims, métricas, assets, screenshots, nombres, URLs y pricing sujetos a su alcance de uso y evidencia específica. → `templates/caso-estudio.md` |
| **SKY — Blog SEO/AEO (Wherex)** | 🔴 **Es un servicio de SEO/CONTENIDO, NO creativo.** **Actualización 2026-09-23: adjudicado a Efeonce** — segundo servicio, para otro comprador dentro de SKY: el **equipo de Marca** *(no Performance)*. CLP 3,0M neto/mes · 24 meses (hasta 2028) · adenda al contrato vigente · inicio 2026-11-01. Las cifras de la oferta original *(5,2M · piso 4,6M · loaded 2,26M)* son **históricas / superseded**. Su dueño es **`seo-aeo-practice`**. 🔴 **NUNCA lo cites como caso creativo ni afirmes que el squad creativo atiende el blog** *(no confirmado)*. |
| **Bresler** | ✅ **+180% de tráfico orgánico** *(dato duro, citable)*. ⚠️ Es SEO, no creativo. |
| **Berel** | ✅ Cliente real. |
| **Caso Travel Sale · Sky Airline** *(Notion `MET-1530`, aprobado)* | ✅ Caso detallado de eficiencia de producción: 4 mercados + Brasil, 178 piezas (66 de Efeonce), −21–25% tiempo de campaña, 27 piezas (9 videos) en 10 min. Con PDF/one-pager, blog y video. Autorización para citar fuera: verificar. |
| 🔴 **Casos creativos con métrica de NEGOCIO verificable + autorización escrita del cliente** | 🔴 **Hoy: ninguno formalizado.** *(SKY prueba delivery, no resultado de negocio.)* |

> 🔴 **Esta es la debilidad estructural de la práctica creativa hoy: tenemos trabajo y un caso de delivery publicado (SKY), pero ningún caso de RESULTADO de negocio.** *(Actualización 2026-09-23: antes decía "no tenemos CASOS"; ya no es cierto.)*
> Un caso no es un lindo mockup en un deck. Es: **métrica verificable + relación sana + autorización escrita.**
>
> 🎯 **Y por eso, mientras no tengamos caso de negocio, el peso de la prueba lo cargan otras dos cosas — y tienen que
