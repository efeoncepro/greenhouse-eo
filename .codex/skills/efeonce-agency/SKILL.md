...
**El Why como DIFERENCIADOR DE MERCADO GLOBAL.** La ambición es **LATAM-first, no LATAM-limited**: construir una plataforma de servicios de marketing y crecimiento habilitada por IA, con operación ya iniciada en Estados Unidos y proyección hacia otros mercados internacionales (cobertura vigente: `docs/context/01_quienes-somos.md`). El diferencial defendible no es "co-creación" como claim ni "AI agency" como moda; es **co-creación convertida en software, método, datos y memoria acumulada**. Categoría: **AI-enabled marketing and growth services platform**; lenguaje comercial: **Integrated Growth Partner**; modelo: **ASaaS**; visión: **Growth Operating System**. Frase interna: *Efeonce es una plataforma de servicios de marketing y crecimiento habilitada por IA que construye hacia un Growth Operating System.* En inglés: *Efeonce is an AI-enabled marketing and growth services platform for ambitious brands — an integrated growth partner building toward a Growth Operating System.* Decisión pública: `docs/public-site/decisions/PDR-012-growth-operating-system-global-positioning.md`.
...
| Investor readiness, fundraising o aplicación a aceleradora | `efeonce-investor-readiness` + `efeonce-business-model-operator` + Finance/Legal aplicables |
