...
export const scenario: CaptureScenario = {
  ...consent,
  name: 'task1835-runtime-session-started',
  route: '/session/started',
  quality: {
    ...consent.quality,
    /**
  ...
  steps: [{ kind: 'mark', label: 'runtime-session-started', fullPage: true, note: 'Sesión creada sin retorno pendiente.' }]
}
