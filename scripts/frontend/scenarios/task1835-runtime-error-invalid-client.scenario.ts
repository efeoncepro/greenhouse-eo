...
export const scenario: CaptureScenario = {
  ...consent,
  name: 'task1835-runtime-error-invalid-client',
  route: '/error/invalid-client',
  quality: {
    ...consent.quality,
    /**
  ...
  steps: [{ kind: 'mark', label: 'runtime-error-invalid-client', fullPage: true, note: 'Error del protocolo: código visible, sin redirect ni detalle interno.' }]
}
