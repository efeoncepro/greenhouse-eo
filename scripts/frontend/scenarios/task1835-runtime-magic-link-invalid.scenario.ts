...
export const scenario: CaptureScenario = {
  ...consent,
  name: 'task1835-runtime-magic-link-invalid',
  ...
  steps: [{ kind: 'mark', label: 'runtime-magic-link-invalid', fullPage: true, note: 'Enlace inválido: mismo título que vencido y usado.' }]
}
