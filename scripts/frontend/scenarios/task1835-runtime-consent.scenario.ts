...
/** Local first-fold fixtures only: AGENT_AUTH_BASE_URL=http://127.0.0.1:19036. */
export const scenario: CaptureScenario = {
  name: 'task1835-runtime-consent',
  route: '/consent',
  ...
  steps: [{ kind: 'mark', label: 'runtime-consent', fullPage: true, note: 'Renderer real con datos ficticios; no se concede acceso.' }]
}
