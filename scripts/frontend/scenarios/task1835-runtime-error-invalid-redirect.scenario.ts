...
export const scenario: CaptureScenario = {
  ...consent,
  name: 'task1835-runtime-error-invalid-redirect',
  route: '/error/invalid-redirect',
  quality: {
    ...consent.quality,
  ...
  steps: [{ kind: 'mark', label: 'runtime-error-invalid-redirect', fullPage: true, note: 'Dirección de retorno no registrada: se dice sin redirigir.' }]
}
