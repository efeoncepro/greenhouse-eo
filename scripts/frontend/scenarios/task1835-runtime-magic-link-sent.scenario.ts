...
export const scenario: CaptureScenario = {
  ...consent,
  name: 'task1835-runtime-magic-link-sent',
  ...
  steps: [{ kind: 'mark', label: 'runtime-magic-link-sent', fullPage: true, note: 'Copy idéntico exista o no el correo: no revela si la invitación existe.' }]
}
