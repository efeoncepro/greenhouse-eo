...
const main = async () => {
  ...
  const sqlPath = path.resolve(process.cwd(), 'scripts/setup-bigquery-nubox-conformed.sql')
  ...
  console.log(`Applied ${statements.length} BigQuery statements for Nubox conformed tables.`)
}
