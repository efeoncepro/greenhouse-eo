...
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA greenhouse_sync TO greenhouse_migrator;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA greenhouse_notifications TO greenhouse_migrator;
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA greenhouse_sync TO greenhouse_runtime;
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA greenhouse_notifications TO greenhouse_runtime;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA greenhouse_sync TO greenhouse_migrator;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA greenhouse_notifications TO greenhouse_migrator;
ALTER DEFAULT PRIVILEGES FOR ROLE greenhouse_ops IN SCHEMA greenhouse_sync GRANT ALL PRIVILEGES ON TABLES TO greenhouse_ops;
ALTER DEFAULT PRIVILEGES FOR ROLE greenhouse_ops IN SCHEMA greenhouse_notifications GRANT ALL PRIVILEGES ON TABLES TO greenhouse_ops;
...
ALTER DEFAULT PRIVILEGES FOR ROLE greenhouse_ops IN SCHEMA greenhouse_sync GRANT ALL PRIVILEGES ON TABLES TO greenhouse_migrator;
...
ALTER DEFAULT PRIVILEGES FOR ROLE greenhouse_ops IN SCHEMA greenhouse_sync GRANT USAGE, SELECT ON SEQUENCES TO greenhouse_runtime;
...
ALTER DEFAULT PRIVILEGES FOR ROLE greenhouse_ops IN SCHEMA greenhouse_sync GRANT ALL PRIVILEGES ON SEQUENCES TO greenhouse_migrator;
