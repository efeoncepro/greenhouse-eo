...
export const CATALOGO = [
  ...
  { nombre: 't10-espacio-sin-glifo', objetivo: 'compositor', cambios: [["filter(ch => ch !== ' ' && ch !== '\\n')", 'filter(ch => !/\\s/u.test(ch))']], pruebas: 'P07', espera: /espacio U\+202F que la fuente no tiene ✗/ },
