...
export const CATALOGO = [
  ...
  { nombre: 't12-alfa-libre', objetivo: 'compositor', cambios: [['  if (st.channels.length === 4 && st.channels[3].min < 255) throw new Error(', '  if (false) throw new Error(']], pruebas: 'P07', espera: /plate con transparencia ✗/ },
