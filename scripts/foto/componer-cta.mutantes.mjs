...
export const CATALOGO = [
  ...
  { nombre: 't10-escala-sin-techo', objetivo: 'modulo', modulo: 'cta-esquema.mjs', prueba: 'cta-esquema.test.mjs', cambios: [['    cursorScale: positivo.max(2).optional(),', '    cursorScale: positivo.optional(),']], espera: /Las escalas de la selección tienen techo/ },
  ...
  { nombre: 't11-firma-sube', objetivo: 'compositor', cambios: [['protect, nuevo ? Math.ceil(H * PISO_FIRMA) : 0)', 'protect, 0)']], pruebas: 'P06', espera: /la firma automática del canon nuevo queda en el cuarto inferior: false/ },
  ...
  { nombre: 't13-entidad-sin-digitos', objetivo: 'modulo', modulo: 'cta-esquema.mjs', prueba: 'cta-esquema.test.mjs', cambios: [["    const ent = t.match(/&(#\\d+|#x[0-9a-f]+|[a-z][a-z0-9]*);/i)", "    const ent = t.match(/&(#\\d+|#x[0-9a-f]+|[a-z]+);/i)"]], espera: /Marcado, entidades, saltos de línea y placement chico/ },
  ...
  { nombre: 't13-sin-sujeto-en-qa', objetivo: 'compositor', cambios: [["...(s.selection?.box && opts.mask ? { seleccionSujeto: fraccionSujeto(opts.mask, s.selection.box, s.protect ?? []) } : {}), ", '']], pruebas: 'P10', espera: /rechaza selección sobre nada ✗/ },
  ...
  { nombre: 'gate-t13-descriptor', objetivo: 'gate', cambios: [["p.cta.descriptorGap > p.cta.fontSize * TECHO_DESCRIPTOR + 1e-9 && bloquea(", "false && bloquea("]], pruebas: 'P10', espera: /rechaza descriptor lejos del botón ✗/ },
