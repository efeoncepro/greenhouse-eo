...
const itConAssets = HAY_ASSETS ? it : it.skip
...
describe('la prenda se copia tal cual; el macro sólo refuerza el detalle', () => {
  ...
  itConAssets('una prenda con emblema aporta DOS referencias: la prenda y el macro', () => {
  ...
  itConAssets('cada prenda declara QUÉ marca lleva y el bloque la describe', () => {
  ...
  itConAssets('la gorra va sin macro: su marca ya se lee en la prenda', () => {
    expect(construirPrompt({ ...base, objetos: [{ objeto: 'gorra-efeonce', vista: 'frente' }] }).imagenes).toHaveLength(1)
  })

  itConAssets('las prendas de emblema pequeño declaran su macro', () => {
...
describe('el polo existe en dos colores y la principal es la navy', () => {
  ...
  itConAssets('sin declarar color, usa la navy', () => {
  ...
  itConAssets('la blanca se puede pedir, y arrastra su propio macro', () => {
  ...
  itConAssets('el bloque lleva el ancla de tamaño, no sólo la doc', () => {
...
describe('el asset de USO es la prenda puesta, y es el defecto', () => {
  ...
  itConAssets('declara que la persona de la referencia no cuenta', () => {
  ...
  itConAssets('pedir la vista explícita devuelve la prenda aislada, para construir', () => {
    const { imagenes } = construirPrompt({ ...base, objetos: [{ objeto: 'polo-efeonce', vista: 'frente' }] })
