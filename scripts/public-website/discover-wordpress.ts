...
const loadLocalEnvFiles = () => {
  ...
  return candidates.filter(loadEnvFile)
}

const localEnvFilesLoaded = loadLocalEnvFiles()
...
> Local env files loaded: ${report.localEnvFilesLoaded.join(', ') || 'none'}
