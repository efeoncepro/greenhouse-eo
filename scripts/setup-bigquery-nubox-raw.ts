...
const main = async () => {
  ...
  const sqlPath = path.resolve(process.cwd(), 'scripts/setup-bigquery-nubox-raw.sql')
  ...
  console.log(`Applied ${statements.length} BigQuery statements for Nubox raw snapshot tables.`)
}
